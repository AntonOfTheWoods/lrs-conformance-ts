...
export const v2StatementsQueryExclusiveVoidedStatementIdWithActivityCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-activity",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with activity",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
