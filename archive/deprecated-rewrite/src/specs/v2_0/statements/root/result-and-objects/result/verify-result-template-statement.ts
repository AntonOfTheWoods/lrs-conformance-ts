...
export const v2StatementsVerifyResultTemplateStatementCase = {
  "type": "case",
  "id": "v2.statements.verify.result-template.statement",
  "title": "A Statement accepts a statement result default verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "result": {
            ...
            "success": true,
            "completion": true,
            "response": "proof verify result response 0",
            "duration": "PT1H0M0.1S",
            "extensions": {
