...
export const v2StatementsScoreMaxValidStatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.max-valid.statement-bounded",
  "title": "A Statement accepts a statement result when score uses max above min with raw between them",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00080",
