...
export const v2StatementsVerifyResultTemplateSubstatementCase = {
  "type": "case",
  "id": "v2.statements.verify.result-template.substatement",
  "title": "A Statement accepts a substatement result default verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
        ...
        "value": {
          ...
          "object": {
            ...
            "result": {
              ...
              "success": true,
              "completion": true,
              "response": "proof verify result response 1",
              "duration": "PT1H0M0.1S",
              "extensions": {
