...
export const v2StatementsVerifyActivityDefinitionStatementMoreInfoCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.statement-more-info",
  "title": "A Statement accepts a statement Activity object verify template when definition contains only \"moreInfo\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-definition-more-info",
            "definition": {
