...
export const v2StatementsScoreRawValidStatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.raw-valid.statement-bounded",
  "title": "A Statement accepts a statement result when score uses raw between min and max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
