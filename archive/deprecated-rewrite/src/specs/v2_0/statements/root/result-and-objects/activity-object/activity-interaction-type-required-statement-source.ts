...
export const v2StatementsActivityInteractionTypeRequiredStatementSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.statement-source",
  "title": "A Statement rejects a statement Activity object when source is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-source-without-interaction-type",
            "definition": {
              "source": [
                {
                  "id": "source-a",
