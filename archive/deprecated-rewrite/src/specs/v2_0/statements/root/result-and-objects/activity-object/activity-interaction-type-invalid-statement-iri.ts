...
export const v2StatementsActivityInteractionTypeInvalidStatementIriCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.statement-iri",
  "title": "A Statement rejects a statement Activity object when definition.interactionType uses an IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-invalid-interaction-type-iri",
            "definition": {
