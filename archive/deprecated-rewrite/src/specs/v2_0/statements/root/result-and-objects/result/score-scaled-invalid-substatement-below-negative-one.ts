...
export const v2StatementsScoreScaledInvalidSubstatementBelowNegativeOneCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-invalid.substatement-below-negative-one",
  "title": "A Statement rejects a substatement result when scaled is -1.00001",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
