...
export const v2StatementsActivityInteractionTypeRequiredSubstatementCorrectResponsesPatternCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.substatement-correct-responses-pattern",
  "title": "A Statement rejects a substatement Activity object when correctResponsesPattern is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-correct-responses-pattern-without-interaction-type",
              "definition": {
