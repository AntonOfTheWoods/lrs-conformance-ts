...
export const v2StatementsActivityInteractionTypeInvalidSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.substatement-numeric",
  "title": "A Statement rejects a substatement Activity object when definition.interactionType uses a number",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-invalid-interaction-type-numeric",
              "definition": {
                "interactionType": 12345,
