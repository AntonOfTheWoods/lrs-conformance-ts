...
export const v2StatementsResultDurationValidStatementWeeksCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.statement-weeks",
  "title": "A Statement accepts a statement result when duration is P4W",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
