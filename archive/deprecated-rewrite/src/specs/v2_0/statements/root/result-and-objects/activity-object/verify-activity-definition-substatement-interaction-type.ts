...
export const v2StatementsVerifyActivityDefinitionSubstatementInteractionTypeCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.substatement-interaction-type",
  "title": "A Statement accepts a substatement Activity object verify template when definition contains only \"interactionType\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-definition-interaction-type",
              "definition": {
