...
export const v2StatementsActivityInteractionComponentsDescriptionTypeStatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.statement-sequencing-choices",
  "title": "A Statement rejects a statement Activity object when sequencing \"choices\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-sequencing-choices-description-type",
            "definition": {
