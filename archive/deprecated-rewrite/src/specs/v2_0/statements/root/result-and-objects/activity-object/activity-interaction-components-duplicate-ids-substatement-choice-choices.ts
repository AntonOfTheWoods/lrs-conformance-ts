...
export const v2StatementsActivityInteractionComponentsDuplicateIdsSubstatementChoiceChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.duplicate-ids.substatement-choice-choices",
  "title": "A Statement rejects a substatement Activity object when choice \"choices\" reuses an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-choice-choices-duplicate-ids",
              "definition": {
