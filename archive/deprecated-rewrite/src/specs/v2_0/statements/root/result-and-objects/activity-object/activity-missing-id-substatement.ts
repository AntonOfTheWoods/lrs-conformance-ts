...
export const v2StatementsActivityMissingIdSubstatementCase = {
  "type": "case",
  "id": "v2.statements.activity.missing-id.substatement",
  "title": "A Statement rejects a substatement Activity object when id is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00047",
