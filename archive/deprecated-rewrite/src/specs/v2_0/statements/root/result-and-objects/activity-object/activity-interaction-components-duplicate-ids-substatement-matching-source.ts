...
export const v2StatementsActivityInteractionComponentsDuplicateIdsSubstatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.duplicate-ids.substatement-matching-source",
  "title": "A Statement rejects a substatement Activity object when matching \"source\" reuses an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-source-duplicate-ids",
              "definition": {
