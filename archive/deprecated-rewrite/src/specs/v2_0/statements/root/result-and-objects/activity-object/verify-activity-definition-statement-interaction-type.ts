...
export const v2StatementsVerifyActivityDefinitionStatementInteractionTypeCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.statement-interaction-type",
  "title": "A Statement accepts a statement Activity object verify template when definition contains only \"interactionType\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-definition-interaction-type",
            "definition": {
