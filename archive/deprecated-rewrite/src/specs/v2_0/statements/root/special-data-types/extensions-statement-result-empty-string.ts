...
export const v2StatementsSpecialDataTypesExtensionsStatementResultEmptyStringCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.statement-result.empty-string",
  "title": "The Statements resource accepts PUT when statement result extensions extension values can be empty string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005105"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005105",
          "actor": {
            "objectType": "Agent",
          ...
          "timestamp": "2026-05-23T13:25:05.000Z",
          "result": {
            "score": {
              "scaled": 0.6767676,
              "raw": 0.6767676,
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types statement-result empty-string",
