...
export const v2StatementsLanguageMapsLegacyRejectedSubstatementVerbDisplayCase = {
  "type": "case",
  "id": "v2.statements.language-maps.legacy-rejected.substatement-verb-display",
