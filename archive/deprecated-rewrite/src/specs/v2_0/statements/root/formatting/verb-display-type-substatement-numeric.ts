...
export const v2StatementsVerbDisplayTypeSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.verb.display-type.substatement-numeric",
  "title": "A Statement rejects a substatement verb when display is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00045",
