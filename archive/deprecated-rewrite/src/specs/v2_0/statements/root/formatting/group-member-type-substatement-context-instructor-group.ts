...
export const v2StatementsGroupMemberTypeSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-type.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when member is not an array of Agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00036",
