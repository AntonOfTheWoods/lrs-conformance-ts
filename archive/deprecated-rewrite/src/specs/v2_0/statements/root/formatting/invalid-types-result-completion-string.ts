...
export const v2StatementsInvalidTypesResultCompletionStringCase = {
  "type": "case",
  "id": "v2.statements.invalid-types.result-completion-string",
  ...
  "assertion": {
    ...
    "notes": [
      ...
      "legacy note: XAPI-00006 upstream comment - in formatting.js",
    ]
  }
