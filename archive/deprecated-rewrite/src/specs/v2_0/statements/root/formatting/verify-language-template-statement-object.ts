...
export const v2StatementsVerifyLanguageTemplateStatementObjectCase = {
  "type": "case",
  "id": "v2.statements.verify.language-template.statement-object",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-language-statement",
            "definition": {
