...
export const v2StatementsInvalidOpenidActorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.actor-group",
  "title": "A Statement rejects statement actor \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
