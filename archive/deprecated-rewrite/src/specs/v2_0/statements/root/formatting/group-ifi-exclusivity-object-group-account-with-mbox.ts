...
export const v2StatementsGroupIfiExclusivityObjectGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-account-with-mbox",
  "title": "A Statement rejects statement object \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
