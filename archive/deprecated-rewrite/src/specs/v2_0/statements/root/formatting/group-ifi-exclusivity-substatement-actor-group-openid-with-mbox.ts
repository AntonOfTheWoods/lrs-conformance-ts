...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-openid-with-mbox",
  "title": "A Statement rejects statement substatement actor \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
