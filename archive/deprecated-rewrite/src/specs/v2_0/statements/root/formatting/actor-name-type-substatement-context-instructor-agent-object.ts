...
export const v2StatementsActorNameTypeSubstatementContextInstructorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.substatement-context-instructor-agent-object",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when name is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
