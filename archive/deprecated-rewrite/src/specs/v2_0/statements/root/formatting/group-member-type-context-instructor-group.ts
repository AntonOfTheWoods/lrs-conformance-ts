...
export const v2StatementsGroupMemberTypeContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-type.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when member is not an array of Agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00036",
