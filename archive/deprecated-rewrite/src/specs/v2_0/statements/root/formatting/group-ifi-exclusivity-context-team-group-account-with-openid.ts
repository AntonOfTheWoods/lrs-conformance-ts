...
export const v2StatementsGroupIfiExclusivityContextTeamGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-account-with-openid",
  "title": "A Statement rejects statement context team \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
