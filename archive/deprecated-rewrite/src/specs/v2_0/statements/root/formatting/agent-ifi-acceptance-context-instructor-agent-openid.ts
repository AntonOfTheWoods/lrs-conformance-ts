...
export const v2StatementsAgentIfiAcceptanceContextInstructorAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.context-instructor-agent-openid",
  "title": "A Statement accepts statement context instructor \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
