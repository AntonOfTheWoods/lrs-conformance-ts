...
export const v2StatementsAccountHomePageMissingAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.authority-group",
  "title": "A Statement rejects statement authority \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
