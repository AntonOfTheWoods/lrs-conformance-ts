...
export const v2StatementsAgentIfiAcceptanceSubstatementContextInstructorAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.substatement-context-instructor-agent-openid",
  "title": "A Statement accepts statement substatement context instructor \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
