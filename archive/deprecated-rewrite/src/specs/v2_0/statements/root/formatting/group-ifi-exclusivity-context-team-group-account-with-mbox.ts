...
export const v2StatementsGroupIfiExclusivityContextTeamGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-account-with-mbox",
  "title": "A Statement rejects statement context team \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
