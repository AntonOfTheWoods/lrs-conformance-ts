...
export const v2StatementsGroupIfiExclusivityObjectGroupMboxSha1sumWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-mbox-sha1sum-with-account",
  "title": "A Statement rejects statement object \"group\" when mbox_sha1sum is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
