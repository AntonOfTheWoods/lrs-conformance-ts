...
export const v2StatementsInvalidMboxSha1sumContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
