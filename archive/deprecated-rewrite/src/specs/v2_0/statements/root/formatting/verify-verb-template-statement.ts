...
export const v2StatementsVerifyVerbTemplateStatementCase = {
  "type": "case",
  "id": "v2.statements.verify.verb-template.statement",
  "title": "A Statement accepts a statement verb verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "verb": {
            "id": "https://example.test/xapi/verbs/verify-template-statement",
            "display": {
              "en-US": "verified"
            }
          },
