...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-account-with-mbox",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
