...
export const v2StatementsActorObjectTypeVocabularyActorAgentAgentCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.actor-agent-agent",
  "title": "A Statement rejects statement actor \"agent\" when objectType is not \"Agent\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
