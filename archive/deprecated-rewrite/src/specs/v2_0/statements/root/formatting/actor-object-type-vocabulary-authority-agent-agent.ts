...
export const v2StatementsActorObjectTypeVocabularyAuthorityAgentAgentCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.authority-agent-agent",
  "title": "A Statement rejects statement authority \"agent\" when objectType is not \"Agent\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
