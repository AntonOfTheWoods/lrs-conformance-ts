...
export const v2StatementsAccountPropertyAcceptanceSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-property-acceptance.substatement-context-instructor-agent",
