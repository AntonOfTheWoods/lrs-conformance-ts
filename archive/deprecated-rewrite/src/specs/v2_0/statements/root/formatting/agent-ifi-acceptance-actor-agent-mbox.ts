...
export const v2StatementsAgentIfiAcceptanceActorAgentMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.actor-agent-mbox",
  "title": "A Statement accepts statement actor \"agent\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
