...
export const v2StatementsGroupIfiExclusivityActorGroupOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement actor \"group\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
