...
export const v2StatementsAccountHomePageMissingActorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.actor-group",
  "title": "A Statement rejects statement actor \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
