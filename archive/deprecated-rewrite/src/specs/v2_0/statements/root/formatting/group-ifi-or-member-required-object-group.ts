...
export const v2StatementsGroupIfiOrMemberRequiredObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.object-group",
  "title": "A Statement rejects statement object \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
