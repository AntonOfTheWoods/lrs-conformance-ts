...
export const v2StatementsAgentIfiAcceptanceObjectAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.object-agent-openid",
  "title": "A Statement accepts statement object \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
