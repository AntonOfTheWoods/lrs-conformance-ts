...
export const v2StatementsGroupMemberRequiredActorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.actor-group",
  "title": "A Statement rejects statement actor \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
