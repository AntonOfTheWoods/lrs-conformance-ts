...
export const v2StatementsVerifyGroupTemplateAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.authority-group",
  "title": "A Statement accepts statement authority \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
