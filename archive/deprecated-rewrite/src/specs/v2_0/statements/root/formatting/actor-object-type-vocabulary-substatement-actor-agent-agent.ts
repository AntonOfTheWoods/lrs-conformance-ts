...
export const v2StatementsActorObjectTypeVocabularySubstatementActorAgentAgentCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.substatement-actor-agent-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when objectType is not \"Agent\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
