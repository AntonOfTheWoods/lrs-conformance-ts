...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-openid-with-mbox",
  "title": "A Statement rejects statement context instructor \"agent\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
