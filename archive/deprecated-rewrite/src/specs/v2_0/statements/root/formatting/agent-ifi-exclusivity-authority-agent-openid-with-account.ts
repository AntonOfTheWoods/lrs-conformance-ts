...
export const v2StatementsAgentIfiExclusivityAuthorityAgentOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-openid-with-account",
  "title": "A Statement rejects statement authority \"agent\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
