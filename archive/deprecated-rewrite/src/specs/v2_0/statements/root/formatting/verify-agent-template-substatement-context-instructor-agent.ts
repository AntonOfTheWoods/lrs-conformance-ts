...
export const v2StatementsVerifyAgentTemplateSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.substatement-context-instructor-agent",
  "title": "A Statement accepts statement substatement context instructor \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
        ...
        "value": {
          ...
          "object": {
            ...
            "context": {
              "instructor": {
                "objectType": "Agent",
                "mbox": "mailto:verify-substatement-context-instructor-agent@example.test",
                "name": "Proof Agent"
              }
            }
          },
