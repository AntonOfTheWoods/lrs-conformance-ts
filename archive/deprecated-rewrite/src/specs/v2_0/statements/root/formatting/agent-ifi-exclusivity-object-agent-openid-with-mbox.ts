...
export const v2StatementsAgentIfiExclusivityObjectAgentOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-openid-with-mbox",
  "title": "A Statement rejects statement object \"agent\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
