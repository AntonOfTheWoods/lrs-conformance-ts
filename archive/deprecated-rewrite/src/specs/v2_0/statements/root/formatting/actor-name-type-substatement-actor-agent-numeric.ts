...
export const v2StatementsActorNameTypeSubstatementActorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.substatement-actor-agent-numeric",
  "title": "A Statement rejects statement substatement actor \"agent\" when name is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
