...
export const v2StatementsInvalidMboxIriAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.authority-group",
  "title": "A Statement rejects statement authority \"group\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
