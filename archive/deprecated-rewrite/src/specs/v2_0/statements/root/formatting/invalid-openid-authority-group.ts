...
export const v2StatementsInvalidOpenidAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.authority-group",
  "title": "A Statement rejects statement authority \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
