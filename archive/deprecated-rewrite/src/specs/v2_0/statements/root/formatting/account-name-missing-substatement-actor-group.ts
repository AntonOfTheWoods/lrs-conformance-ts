...
export const v2StatementsAccountNameMissingSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
