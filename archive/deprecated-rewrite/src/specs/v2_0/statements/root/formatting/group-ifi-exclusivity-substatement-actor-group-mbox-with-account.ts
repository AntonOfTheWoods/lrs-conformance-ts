...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-mbox-with-account",
  "title": "A Statement rejects statement substatement actor \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
