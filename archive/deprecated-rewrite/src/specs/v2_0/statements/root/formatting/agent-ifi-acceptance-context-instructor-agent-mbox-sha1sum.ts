...
export const v2StatementsAgentIfiAcceptanceContextInstructorAgentMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.context-instructor-agent-mbox-sha1sum",
  "title": "A Statement accepts statement context instructor \"agent\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
