...
export const v2StatementsRequiredFieldsMissingObjectCase = {
  "type": "case",
  "id": "v2.statements.required-fields.missing-object",
  ...
  "assertion": {
    ...
    "notes": [
      ...
      "legacy note: XAPI-00005 upstream comment - in formatting.js",
    ]
  }
