...
export const v2StatementsInvalidOpenidSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
