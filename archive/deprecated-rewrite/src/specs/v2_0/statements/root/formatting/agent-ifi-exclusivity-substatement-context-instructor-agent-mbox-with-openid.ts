...
export const v2StatementsAgentIfiExclusivitySubstatementContextInstructorAgentMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-context-instructor-agent-mbox-with-openid",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
