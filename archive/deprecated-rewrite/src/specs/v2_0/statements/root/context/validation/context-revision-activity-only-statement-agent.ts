...
export const v2StatementsContextRevisionActivityOnlyStatementAgentCase = {
  "type": "case",
  "id": "v2.statements.context.revision-activity-only.statement-agent",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Agent",
            "mbox": "mailto:context-revision-statement-agent@example.test",
            "name": "Proof Agent"
          },
