...
export const v2StatementsContextPlatformNoObjectTypeStatementCase = {
  "type": "case",
  "id": "v2.statements.context.platform-no-object-type.statement",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "id": "https://example.test/xapi/activities/context-platform-no-object-type"
          },
