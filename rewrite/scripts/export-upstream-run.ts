...
function buildUpstreamNodeSuiteBootstrapCommand(
  ...
  return [
    ...
    '  if ! "$runtime_bun_binary_path" install --production --no-save; then',
    '    echo "[conformance] Bun dependency hydration failed for legacy suite ranges; falling back to npm"',
