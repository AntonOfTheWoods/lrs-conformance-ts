      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{groups.identified_openid}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{groups.anonymous_no_member}}" }],
          expect: [400],
        },
      ],
    },
