  ...
  return [
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.anonymous_no_member}}" }],
          expect: [400],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_mbox}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "mbox_sha1sum"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_mbox_sha1sum}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "openid"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_openid}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "account"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_account}}" }],
          expect: [200],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{groups.identified_mbox}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as group identified group accepts "mbox_sha1sum"',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{groups.identified_mbox_sha1sum}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as group identified group accepts "openid"',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{groups.identified_openid}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as group identified group accepts "account"',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{groups.identified_account}}" }],
          expect: [200],
        },
        {
    ...
    },
    {
      ...
      config: [
        {
          name: 'statement actor identified group accepts "mbox"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_mbox_no_member}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "mbox_sha1sum"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_mbox_sha1sum_no_member}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "openid"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_openid_no_member}}" }],
          expect: [200],
        },
        {
          name: 'statement actor identified group accepts "account"',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_account_no_member}}" }],
          expect: [200],
        },
        {
          name: 'statement context instructor identified group accepts "mbox"',
        ...
        {
          name: 'statement substatement as group identified group accepts "mbox"',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{groups.identified_mbox_no_member}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as group identified group accepts "mbox_sha1sum"',
