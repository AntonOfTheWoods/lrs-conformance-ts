      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.object_activity}}" }, { object: "{{activities.no_id}}" }],
          expect: [400],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.object_activity}}" }, { object: "{{activities.numeric_name}}" }],
          expect: [400],
        },
        {
          name: 'statement object "name" language map is string',
          templates: [{ statement: "{{statements.object_activity}}" }, { object: "{{activities.string_name}}" }],
          expect: [400],
        },
        {
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.object_activity}}" }, { object: "{{activities.string_description}}" }],
          expect: [400],
        },
        {
