      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_NUMERIC] }],
          expect: [400],
        },
        {
          name: 'statement "attachment" invalid string',
          templates: [{ statement: "{{statements.authority}}" }, { attachments: [INVALID_STRING] }],
          expect: [400],
        },
      ],
    },
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_USAGE_TYPE] }],
          expect: [400],
        },
      ],
    },
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_LENGTH] }],
          expect: [400],
        },
      ],
    },
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_SHA2] }],
          expect: [400],
        },
      ],
    },
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_FILE_URL] }],
          expect: [400],
        },
      ],
    },
