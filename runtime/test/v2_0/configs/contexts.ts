      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.object_agent_default}}" }, { context: "{{contexts.no_platform}}" }],
          expect: [400],
        },
        {
          name: 'statement context "revision" is invalid with object group',
          templates: [{ statement: "{{statements.object_group_default}}" }, { context: "{{contexts.no_platform}}" }],
          expect: [400],
        },
        {
          name: 'statement context "revision" is invalid with statementref',
          templates: [{ statement: "{{statements.object_statementref}}" }, { context: "{{contexts.no_platform}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.context_sans_objectType}}" }, { context: "{{contexts.no_platform}}" }],
          expect: [200],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.object_agent_default}}" }, { context: "{{contexts.no_revision}}" }],
          expect: [400],
        },
        {
          name: 'statement context "platform" is invalid with object group',
          templates: [{ statement: "{{statements.object_group_default}}" }, { context: "{{contexts.no_revision}}" }],
          expect: [400],
        },
        {
          name: 'statement context "platform" is invalid with statementref',
          templates: [{ statement: "{{statements.object_statementref}}" }, { context: "{{contexts.no_revision}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.context_sans_objectType}}" }, { context: "{{contexts.no_revision}}" }],
          expect: [200],
        },
        {
