      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.context}}" }, { context: "{{contexts.context_agents}}" }],
          expect: [200],
        },
        {
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.context}}" }, { context: INVALID_RELEVANT_TYPE_IS_EMPTY }],
          expect: [400],
        },
        {
          name: 'Statement with "contextAgents" Object rejects statement if "relevantTypes" contains non-IRI elements',
          templates: [{ statement: "{{statements.context}}" }, { context: INVALID_RELEVANT_TYPE_NON_IRI_ELEMENT }],
          expect: [400],
        },
        {
