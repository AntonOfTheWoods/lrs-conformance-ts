    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.result}}" }, { result: "{{results.no_extensions}}" }, VALID_EXTENSION],
          expect: [200],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.default}}" }, { id: INVALID_NUMERIC }],
          expect: [400],
        },
        {
          name: 'statement "id" invalid object',
          templates: [{ statement: "{{statements.default}}" }, { id: INVALID_OBJECT }],
          expect: [400],
        },
        {
          name: 'statement "id" invalid UUID with too many digits',
          templates: [{ statement: "{{statements.default}}" }, { id: INVALID_UUID_TOO_MANY_DIGITS }],
          expect: [400],
        },
        {
          name: 'statement "id" invalid UUID with non A-F',
          templates: [{ statement: "{{statements.default}}" }, { id: INVALID_UUID_INVALID_LETTER }],
          expect: [400],
        },
        {
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.default}}" }, { STOred: new Date("Sep 17, 1787 09:33:32:1111111") }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.default}}" }, { Version: "1.0.3" }],
          expect: [400],
        },
        {
          name: 'should fail when not using "attachments"',
          templates: [{ statement: "{{statements.attachment}}" }, { attachmentS: [VALID_ATTACHMENT] }],
          expect: [400],
        },
      ],
    },
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [VALID_ATTACHMENT_DISPLAY] }],
          expect: [200],
        },
        {
          name: 'statement attachment "display" should fail given invalid language code',
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_DISPLAY_ATTACHMENT] }],
          expect: [400],
        },
        {
          name: 'statement attachment "description" should pass given es-MX language-UN region code',
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [VALID_ATTACHMENT_DESCRIPTION] }],
          expect: [200],
        },
        {
          name: 'statement attachment "description" should fail given es-MX invalid language code',
          templates: [{ statement: "{{statements.attachment}}" }, { attachments: [INVALID_DESCRIPTION_ATTACHMENT] }],
          expect: [400],
        },
        {
