    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.account}}" }],
          expect: [200],
        },
        {
          name: 'statement actor "mbox" should pass',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.mbox}}" }],
          expect: [200],
        },
        {
          name: 'statement actor "mbox_sha1sum" should pass',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.mbox_sha1sum}}" }],
          expect: [200],
        },
        {
          name: 'statement actor "openid" should pass',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.openid}}" }],
          expect: [200],
        },
        {
          name: 'statement authority without "account", "mbox", "mbox_sha1sum", "openid" should fail',
          templates: [{ statement: "{{statements.authority}}" }],
          expect: [400],
        },
        {
          name: 'statement authority "account" should pass',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.account}}" }],
          expect: [200],
        },
        {
          name: 'statement authority "mbox" should pass',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.mbox}}" }],
          expect: [200],
        },
        {
          name: 'statement authority "mbox_sha1sum" should pass',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.mbox_sha1sum}}" }],
          expect: [200],
        },
        {
          name: 'statement authority "openid" should pass',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.openid}}" }],
          expect: [200],
        },
        {
          name: 'statement context instructor without "account", "mbox", "mbox_sha1sum", "openid" should fail',
          templates: [{ statement: "{{statements.context}}" }, { context: "{{contexts.instructor}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.object_actor}}" }],
          expect: [400],
        },
        {
          name: 'statement substatement as agent "account" should pass',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.account}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as agent "mbox" should pass',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.mbox}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as agent "mbox_sha1sum" should pass',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.mbox_sha1sum}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement as agent "openid" should pass',
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.openid}}" }],
          expect: [200],
        },
        {
          name: 'statement substatement"s agent without "account", "mbox", "mbox_sha1sum", "openid" should fail',
          templates: [{ statement: "{{statements.object_substatement}}" }, { object: "{{substatements.actor}}" }],
          expect: [400],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.mbox}}" }, FOREIGN_IDENTIFIER_ACCOUNT],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.mbox}}" }, FOREIGN_IDENTIFIER_OPENID],
          expect: [400],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.account}}" }, FOREIGN_IDENTIFIER_MBOX],
          expect: [400],
        },
        {
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.openid}}" }, FOREIGN_IDENTIFIER_MBOX],
          expect: [400],
        },
        {
