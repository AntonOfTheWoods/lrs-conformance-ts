    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.result}}" }, { result: "{{results.no_extensions}}" }, NULL_VALUE],
          expect: [200],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.context}}" }, { context: "{{contexts.no_extensions}}" }, NULL_VALUE],
          expect: [200],
        },
        {
          name: "statement context extensions can be empty object",
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.result}}" }, { result: "{{results.default}}" }, INVALID_EXTENSION_KEY],
          expect: [400],
        },
        {
