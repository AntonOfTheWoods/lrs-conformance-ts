...
import { captureOwnerHeaderName, decodeCaptureOwnerLabel } from "../../shared/execution/execution-owner.ts";
...
function usage(): string {
  return [
    "Usage:",
    "  bun ./legacy/scripts/attribute-db-divergence.ts --report <bisect-report.json> [--out <path>]",
    "",
    "Notes:",
