...
export const v2StatementsSpecialDataTypesExtensionsSubstatementContextNullCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.substatement-context.null",
  "title": "The Statements resource accepts PUT when statement substatement context extensions extension values can be null",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005122"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005122",
          "actor": {
            "objectType": "Agent",
          ...
          "timestamp": "2026-05-23T13:25:22.000Z"
        },
        "sourceFixture": {
          "version": "2.0.0",
          "domain": "statements",
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types substatement-context null",
