...
export const v2StatementsSpecialDataTypesExtensionsSubstatementActivityEmptyObjectCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.substatement-activity.empty-object",
  "title": "The Statements resource accepts PUT when statement substatement activity extensions extension values can be empty object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005115"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005115",
          "actor": {
            "objectType": "Agent",
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/special-data-types/substatement/5115",
              "definition": {
                "extensions": {
                  "http://example.com/ex": {}
                }
          ...
          "timestamp": "2026-05-23T13:25:15.000Z"
        },
        "sourceFixture": {
          "version": "2.0.0",
          "domain": "statements",
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types substatement-activity empty-object",
