...
export const v2StatementsSpecialDataTypesExtensionsStatementContextEmptyObjectCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.statement-context.empty-object",
  "title": "The Statements resource accepts PUT when statement context extensions extension values can be empty object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005111"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005111",
          "actor": {
            "objectType": "Agent",
          ...
          "timestamp": "2026-05-23T13:25:11.000Z",
          "context": {
            "extensions": {
              "http://example.com/ex": {}
            }
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types statement-context empty-object",
