...
export const v2StatementsSpecialDataTypesExtensionsStatementActivityEmptyStringCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.statement-activity.empty-string",
  "title": "The Statements resource accepts PUT when statement activity extensions extension values can be empty string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005101"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005101",
          "actor": {
            "objectType": "Agent",
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/special-data-types/5101",
            "definition": {
              "extensions": {
                "http://example.com/ex": ""
              }
          ...
          "timestamp": "2026-05-23T13:25:01.000Z"
        },
        "sourceFixture": {
          "version": "2.0.0",
          "domain": "statements",
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types statement-activity empty-string",
