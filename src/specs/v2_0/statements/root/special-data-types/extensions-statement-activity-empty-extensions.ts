...
export const v2StatementsSpecialDataTypesExtensionsStatementActivityEmptyExtensionsCase = {
  "type": "case",
  "id": "v2.statements.special-data-types.extensions.statement-activity.empty-extensions",
  "title": "The Statements resource accepts PUT when statement activity extensions extensions can be empty object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00119",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "statementId": "33333333-3333-4333-8333-000000005100"
      },
      "body": {
        "kind": "json",
        "value": {
          "id": "33333333-3333-4333-8333-000000005100",
          "actor": {
            "objectType": "Agent",
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/special-data-types/5100",
            "definition": {
              "extensions": {}
            }
          },
          "timestamp": "2026-05-23T13:25:00.000Z"
        },
        "sourceFixture": {
          "version": "2.0.0",
          "domain": "statements",
  ...
  "assertion": {
    ...
    "textContains": [],
    "notes": [
      "proof-slice special data types statement-activity empty-extensions",
