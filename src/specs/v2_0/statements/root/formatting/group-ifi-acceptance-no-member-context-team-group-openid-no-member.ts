...
export const v2StatementsGroupIfiAcceptanceNoMemberContextTeamGroupOpenidNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.context-team-group-openid-no-member",
  "title": "A Statement accepts statement context team \"group\" when openid is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
