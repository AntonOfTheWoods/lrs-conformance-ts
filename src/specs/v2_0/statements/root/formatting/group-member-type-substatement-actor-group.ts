...
export const v2StatementsGroupMemberTypeSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-type.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when member is not an array of Agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00036",
