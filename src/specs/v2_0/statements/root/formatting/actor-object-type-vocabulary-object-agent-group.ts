...
export const v2StatementsActorObjectTypeVocabularyObjectAgentGroupCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.object-agent-group",
  "title": "A Statement rejects statement object \"agent\" when objectType is not \"Group\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
