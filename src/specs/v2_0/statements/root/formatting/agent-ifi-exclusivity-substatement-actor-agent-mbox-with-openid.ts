...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-mbox-with-openid",
  "title": "A Statement rejects statement substatement actor \"agent\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
