...
export const v2StatementsAgentIfiExclusivityAuthorityAgentAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-account-with-openid",
  "title": "A Statement rejects statement authority \"agent\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
