...
export const v2StatementsAccountNameMissingObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.object-group",
  "title": "A Statement rejects statement object \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
