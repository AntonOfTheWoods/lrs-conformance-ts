...
export const v2StatementsGroupIfiAcceptanceNoMemberSubstatementActorGroupMboxSha1sumNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.substatement-actor-group-mbox-sha1sum-no-member",
  "title": "A Statement accepts statement substatement actor \"group\" when mbox_sha1sum is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
