...
export const v2StatementsActorObjectTypeVocabularySubstatementContextInstructorAgentGroupCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.substatement-context-instructor-agent-group",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when objectType is not \"Group\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
