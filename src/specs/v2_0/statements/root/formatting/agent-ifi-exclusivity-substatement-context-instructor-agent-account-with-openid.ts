...
export const v2StatementsAgentIfiExclusivitySubstatementContextInstructorAgentAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-context-instructor-agent-account-with-openid",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
