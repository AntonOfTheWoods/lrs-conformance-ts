...
export const v2StatementsInvalidMboxIriContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
