...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-openid-with-mbox",
  "title": "A Statement rejects statement substatement context instructor \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
