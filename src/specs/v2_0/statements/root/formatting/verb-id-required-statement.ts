...
export const v2StatementsVerbIdRequiredStatementCase = {
  "type": "case",
  "id": "v2.statements.verb.id-required.statement",
  "title": "A Statement rejects a statement verb when id is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00044",
