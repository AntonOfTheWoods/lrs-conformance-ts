...
export const v2StatementsAccountNameMissingContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
