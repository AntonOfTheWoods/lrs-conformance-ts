...
export const v2StatementsAgentIfiRequiredObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.object-agent",
  "title": "A Statement rejects statement object \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
