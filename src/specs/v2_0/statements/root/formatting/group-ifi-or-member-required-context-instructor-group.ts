...
export const v2StatementsGroupIfiOrMemberRequiredContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
