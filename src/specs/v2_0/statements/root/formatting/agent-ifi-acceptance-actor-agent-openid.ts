...
export const v2StatementsAgentIfiAcceptanceActorAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.actor-agent-openid",
  "title": "A Statement accepts statement actor \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
