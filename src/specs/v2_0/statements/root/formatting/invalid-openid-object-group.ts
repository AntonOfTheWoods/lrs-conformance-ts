...
export const v2StatementsInvalidOpenidObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.object-group",
  "title": "A Statement rejects statement object \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
