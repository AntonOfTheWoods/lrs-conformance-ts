...
export const v2StatementsAccountHomePageInvalidContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
