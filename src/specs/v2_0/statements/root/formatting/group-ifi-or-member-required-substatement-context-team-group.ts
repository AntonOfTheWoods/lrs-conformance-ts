...
export const v2StatementsGroupIfiOrMemberRequiredSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
