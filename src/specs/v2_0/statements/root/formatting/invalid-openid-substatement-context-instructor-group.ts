...
export const v2StatementsInvalidOpenidSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
