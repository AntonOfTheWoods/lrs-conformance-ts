...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-mbox-with-account",
  "title": "A Statement rejects statement context instructor \"agent\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
