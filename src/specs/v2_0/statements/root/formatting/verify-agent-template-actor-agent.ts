...
export const v2StatementsVerifyAgentTemplateActorAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.actor-agent",
  "title": "A Statement accepts statement actor \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "actor": {
            "objectType": "Agent",
            "mbox": "mailto:verify-actor-agent@example.test",
            "name": "Proof Agent"
          },
          "verb": {
