...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-account-with-mbox",
  "title": "A Statement rejects statement substatement actor \"agent\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
