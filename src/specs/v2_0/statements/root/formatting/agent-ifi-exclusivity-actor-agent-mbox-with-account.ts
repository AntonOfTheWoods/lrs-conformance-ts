...
export const v2StatementsAgentIfiExclusivityActorAgentMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-mbox-with-account",
  "title": "A Statement rejects statement actor \"agent\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
