...
export const v2StatementsGroupIfiAcceptanceContextInstructorGroupMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-instructor-group-mbox-sha1sum",
  "title": "A Statement accepts statement context instructor \"group\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
