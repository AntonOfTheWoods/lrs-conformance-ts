...
export const v2StatementsAgentIfiExclusivitySubstatementContextInstructorAgentMboxSha1sumWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-context-instructor-agent-mbox-sha1sum-with-openid",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when mbox_sha1sum is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
