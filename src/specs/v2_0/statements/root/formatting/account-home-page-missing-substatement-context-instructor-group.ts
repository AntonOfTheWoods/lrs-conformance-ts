...
export const v2StatementsAccountHomePageMissingSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
