...
export const v2StatementsGroupIfiExclusivitySubstatementContextTeamGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-team-group-mbox-with-openid",
  "title": "A Statement rejects statement substatement context team \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
