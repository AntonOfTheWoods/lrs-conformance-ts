...
export const v2StatementsAgentIfiExclusivityObjectAgentMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-mbox-with-account",
  "title": "A Statement rejects statement object \"agent\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
