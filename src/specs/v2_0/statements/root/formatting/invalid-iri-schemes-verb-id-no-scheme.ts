...
export const v2StatementsInvalidIriSchemesVerbIdNoSchemeCase = {
  "type": "case",
  "id": "v2.statements.invalid-iri-schemes.verb-id-no-scheme",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "verb": {
            "id": "example.test/xapi/verbs/completed",
            "display": {
              "en-US": "completed"
            }
          },
  ...
  "assertion": {
    ...
    "notes": [
      ...
      "legacy note: XAPI-00060 upstream comment - in activities.js",
    ]
  }
