...
export const v2StatementsGroupIfiExclusivityAuthorityGroupMboxSha1sumWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-mbox-sha1sum-with-mbox",
  "title": "A Statement rejects statement authority \"group\" when mbox_sha1sum is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
