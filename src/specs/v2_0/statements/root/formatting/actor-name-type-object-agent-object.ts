...
export const v2StatementsActorNameTypeObjectAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.object-agent-object",
  "title": "A Statement rejects statement object \"agent\" when name is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
