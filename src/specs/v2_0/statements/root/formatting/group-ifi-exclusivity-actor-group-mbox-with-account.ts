...
export const v2StatementsGroupIfiExclusivityActorGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-mbox-with-account",
  "title": "A Statement rejects statement actor \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
