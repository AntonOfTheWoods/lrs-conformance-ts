...
export const v2StatementsGroupIfiExclusivityActorGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-account-with-mbox",
  "title": "A Statement rejects statement actor \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
