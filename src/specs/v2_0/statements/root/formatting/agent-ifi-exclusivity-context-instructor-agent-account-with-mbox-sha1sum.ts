...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement context instructor \"agent\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
