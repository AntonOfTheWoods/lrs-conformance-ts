...
export const v2StatementsGroupIfiAcceptanceSubstatementContextTeamGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-context-team-group-account",
  "title": "A Statement accepts statement substatement context team \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
