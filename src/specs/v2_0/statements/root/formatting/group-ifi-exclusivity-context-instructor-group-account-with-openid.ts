...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-account-with-openid",
  "title": "A Statement rejects statement context instructor \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
