...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-mbox-with-account",
  "title": "A Statement rejects statement substatement actor \"agent\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
