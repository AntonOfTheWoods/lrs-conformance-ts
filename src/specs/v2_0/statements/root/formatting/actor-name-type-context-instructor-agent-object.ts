...
export const v2StatementsActorNameTypeContextInstructorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.context-instructor-agent-object",
  "title": "A Statement rejects statement context instructor \"agent\" when name is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
