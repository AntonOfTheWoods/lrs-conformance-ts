...
export const v2StatementsAgentIfiRequiredContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
