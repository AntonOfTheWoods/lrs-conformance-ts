...
export const v2StatementsAccountPropertyAcceptanceSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-property-acceptance.substatement-context-team-group",
