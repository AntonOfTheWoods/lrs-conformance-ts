...
export const v2StatementsCaseSensitiveKeysAuthorityCase = {
  "type": "case",
  "id": "v2.statements.case-sensitive-keys.authority",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "auTHORity": {
            "objectType": "Agent",
            "mbox": "mailto:case-sensitive-authority@example.test",
            "name": "Proof Agent"
          }
        },
        "sourceFixture": {
