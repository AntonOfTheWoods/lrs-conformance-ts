...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-mbox-with-account",
  "title": "A Statement rejects statement context instructor \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
