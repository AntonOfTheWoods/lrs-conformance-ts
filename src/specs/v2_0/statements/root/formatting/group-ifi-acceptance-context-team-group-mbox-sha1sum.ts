...
export const v2StatementsGroupIfiAcceptanceContextTeamGroupMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-team-group-mbox-sha1sum",
  "title": "A Statement accepts statement context team \"group\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
