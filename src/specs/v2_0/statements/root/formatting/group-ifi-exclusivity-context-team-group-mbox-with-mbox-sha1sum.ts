...
export const v2StatementsGroupIfiExclusivityContextTeamGroupMboxWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-mbox-with-mbox-sha1sum",
  "title": "A Statement rejects statement context team \"group\" when mbox is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
