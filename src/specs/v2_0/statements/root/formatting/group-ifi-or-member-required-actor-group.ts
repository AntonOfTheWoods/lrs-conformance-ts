...
export const v2StatementsGroupIfiOrMemberRequiredActorGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.actor-group",
  "title": "A Statement rejects statement actor \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
