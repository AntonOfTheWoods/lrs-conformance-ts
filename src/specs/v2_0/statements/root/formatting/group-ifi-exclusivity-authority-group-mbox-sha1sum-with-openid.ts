...
export const v2StatementsGroupIfiExclusivityAuthorityGroupMboxSha1sumWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-mbox-sha1sum-with-openid",
  "title": "A Statement rejects statement authority \"group\" when mbox_sha1sum is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
