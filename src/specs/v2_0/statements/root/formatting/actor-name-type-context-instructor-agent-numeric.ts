...
export const v2StatementsActorNameTypeContextInstructorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.context-instructor-agent-numeric",
  "title": "A Statement rejects statement context instructor \"agent\" when name is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
