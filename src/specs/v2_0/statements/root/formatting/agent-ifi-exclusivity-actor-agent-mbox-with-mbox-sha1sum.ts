...
export const v2StatementsAgentIfiExclusivityActorAgentMboxWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-mbox-with-mbox-sha1sum",
  "title": "A Statement rejects statement actor \"agent\" when mbox is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
