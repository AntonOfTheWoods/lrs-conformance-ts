...
export const v2StatementsAccountHomePageMissingSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
