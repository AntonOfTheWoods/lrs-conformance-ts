...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-account-with-openid",
  "title": "A Statement rejects statement context instructor \"agent\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
