...
export const v2StatementsAgentIfiAcceptanceActorAgentAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.actor-agent-account",
  "title": "A Statement accepts statement actor \"agent\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
