...
export const v2StatementsAgentIfiExclusivityAuthorityAgentOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-openid-with-mbox",
  "title": "A Statement rejects statement authority \"agent\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
