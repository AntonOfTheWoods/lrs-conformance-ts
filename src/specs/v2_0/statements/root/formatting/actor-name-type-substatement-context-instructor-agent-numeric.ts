...
export const v2StatementsActorNameTypeSubstatementContextInstructorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.substatement-context-instructor-agent-numeric",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when name is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
