...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-openid-with-mbox",
  "title": "A Statement rejects statement substatement actor \"agent\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
