...
export const v2StatementsGroupIfiAcceptanceActorGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.actor-group-mbox",
  "title": "A Statement accepts statement actor \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
