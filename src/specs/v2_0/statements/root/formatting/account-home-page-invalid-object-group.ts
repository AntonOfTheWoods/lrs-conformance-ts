...
export const v2StatementsAccountHomePageInvalidObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.object-group",
  "title": "A Statement rejects statement object \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
