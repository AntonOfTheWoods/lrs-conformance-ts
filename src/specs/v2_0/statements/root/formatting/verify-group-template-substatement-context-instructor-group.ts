...
export const v2StatementsVerifyGroupTemplateSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.substatement-context-instructor-group",
  "title": "A Statement accepts statement substatement context instructor \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
        ...
        "value": {
          ...
          "object": {
            ...
            "context": {
              "instructor": {
                "objectType": "Group",
                "mbox": "mailto:verify-substatement-context-instructor-group@example.test",
                "name": "Proof Group",
                "member": [
                  {
                    "objectType": "Agent",
