...
export const v2StatementsGroupIfiAcceptanceActorGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.actor-group-account",
  "title": "A Statement accepts statement actor \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
