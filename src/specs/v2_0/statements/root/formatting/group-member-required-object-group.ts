...
export const v2StatementsGroupMemberRequiredObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.object-group",
  "title": "A Statement rejects statement object \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
