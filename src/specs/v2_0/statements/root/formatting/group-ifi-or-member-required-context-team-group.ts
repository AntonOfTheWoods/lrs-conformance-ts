...
export const v2StatementsGroupIfiOrMemberRequiredContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
