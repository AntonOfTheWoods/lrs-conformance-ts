...
export const v2StatementsAgentIfiAcceptanceAuthorityAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.authority-agent-openid",
  "title": "A Statement accepts statement authority \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
