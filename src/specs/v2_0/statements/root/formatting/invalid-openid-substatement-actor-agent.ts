...
export const v2StatementsInvalidOpenidSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
