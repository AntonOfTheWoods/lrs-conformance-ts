...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-account-with-openid",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
