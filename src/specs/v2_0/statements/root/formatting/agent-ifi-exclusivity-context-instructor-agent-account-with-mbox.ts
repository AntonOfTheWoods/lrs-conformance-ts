...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-account-with-mbox",
  "title": "A Statement rejects statement context instructor \"agent\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
