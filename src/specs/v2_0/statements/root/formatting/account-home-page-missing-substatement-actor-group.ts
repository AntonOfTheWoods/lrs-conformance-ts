...
export const v2StatementsAccountHomePageMissingSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
