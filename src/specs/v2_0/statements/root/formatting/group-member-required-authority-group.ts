...
export const v2StatementsGroupMemberRequiredAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.authority-group",
  "title": "A Statement rejects statement authority \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
