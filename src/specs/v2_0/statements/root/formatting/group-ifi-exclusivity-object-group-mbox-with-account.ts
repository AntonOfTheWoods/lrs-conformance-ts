...
export const v2StatementsGroupIfiExclusivityObjectGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-mbox-with-account",
  "title": "A Statement rejects statement object \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
