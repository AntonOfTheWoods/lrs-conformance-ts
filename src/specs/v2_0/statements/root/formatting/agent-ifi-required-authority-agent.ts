...
export const v2StatementsAgentIfiRequiredAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
