...
export const v2StatementsAgentIfiAcceptanceContextInstructorAgentMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.context-instructor-agent-mbox",
  "title": "A Statement accepts statement context instructor \"agent\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
