...
export const v2StatementsInvalidMboxMailtoAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
