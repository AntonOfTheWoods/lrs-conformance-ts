...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-openid-with-account",
  "title": "A Statement rejects statement context instructor \"agent\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
