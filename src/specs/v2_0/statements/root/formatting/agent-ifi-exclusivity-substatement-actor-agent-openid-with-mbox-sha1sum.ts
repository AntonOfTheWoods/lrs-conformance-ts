...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement substatement actor \"agent\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
