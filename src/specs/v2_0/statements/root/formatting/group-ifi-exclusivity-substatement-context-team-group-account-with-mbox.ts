...
export const v2StatementsGroupIfiExclusivitySubstatementContextTeamGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-team-group-account-with-mbox",
  "title": "A Statement rejects statement substatement context team \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
