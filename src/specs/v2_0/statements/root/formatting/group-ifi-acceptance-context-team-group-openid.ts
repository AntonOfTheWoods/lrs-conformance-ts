...
export const v2StatementsGroupIfiAcceptanceContextTeamGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-team-group-openid",
  "title": "A Statement accepts statement context team \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
