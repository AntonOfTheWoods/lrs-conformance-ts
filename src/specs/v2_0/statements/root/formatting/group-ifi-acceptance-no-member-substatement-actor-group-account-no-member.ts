...
export const v2StatementsGroupIfiAcceptanceNoMemberSubstatementActorGroupAccountNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.substatement-actor-group-account-no-member",
  "title": "A Statement accepts statement substatement actor \"group\" when account is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
