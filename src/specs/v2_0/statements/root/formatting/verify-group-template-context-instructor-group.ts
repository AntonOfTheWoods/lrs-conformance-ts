...
export const v2StatementsVerifyGroupTemplateContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.context-instructor-group",
  "title": "A Statement accepts statement context instructor \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "context": {
            "instructor": {
              "objectType": "Group",
              "mbox": "mailto:verify-context-instructor-group@example.test",
              "name": "Proof Group",
              "member": [
                {
                  "objectType": "Agent",
