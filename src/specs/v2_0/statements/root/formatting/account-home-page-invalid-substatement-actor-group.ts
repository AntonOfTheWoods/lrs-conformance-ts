...
export const v2StatementsAccountHomePageInvalidSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
