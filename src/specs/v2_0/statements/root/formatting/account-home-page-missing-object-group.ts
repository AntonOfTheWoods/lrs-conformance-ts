...
export const v2StatementsAccountHomePageMissingObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.object-group",
  "title": "A Statement rejects statement object \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
