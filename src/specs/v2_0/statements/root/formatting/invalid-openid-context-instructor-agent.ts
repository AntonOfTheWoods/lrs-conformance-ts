...
export const v2StatementsInvalidOpenidContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
