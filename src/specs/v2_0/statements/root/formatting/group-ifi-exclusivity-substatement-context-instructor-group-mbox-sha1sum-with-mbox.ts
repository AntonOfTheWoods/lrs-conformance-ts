...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupMboxSha1sumWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-mbox-sha1sum-with-mbox",
  "title": "A Statement rejects statement substatement context instructor \"group\" when mbox_sha1sum is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
