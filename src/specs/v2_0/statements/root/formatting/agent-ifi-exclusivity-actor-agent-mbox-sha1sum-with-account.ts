...
export const v2StatementsAgentIfiExclusivityActorAgentMboxSha1sumWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-mbox-sha1sum-with-account",
  "title": "A Statement rejects statement actor \"agent\" when mbox_sha1sum is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
