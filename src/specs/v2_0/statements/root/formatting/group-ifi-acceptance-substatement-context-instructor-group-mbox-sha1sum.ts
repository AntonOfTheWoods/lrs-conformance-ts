...
export const v2StatementsGroupIfiAcceptanceSubstatementContextInstructorGroupMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-context-instructor-group-mbox-sha1sum",
  "title": "A Statement accepts statement substatement context instructor \"group\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
