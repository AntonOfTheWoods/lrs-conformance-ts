...
export const v2StatementsGroupIfiExclusivityAuthorityGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-mbox-with-openid",
  "title": "A Statement rejects statement authority \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
