...
export const v2StatementsInvalidMboxMailtoObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.object-agent",
  "title": "A Statement rejects statement object \"agent\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
