...
export const v2StatementsInvalidMboxSha1sumSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
