...
export const v2StatementsAccountHomePageMissingContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
