...
export const v2StatementsAccountNameMissingAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.authority-group",
  "title": "A Statement rejects statement authority \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
