...
export const v2StatementsGroupIfiAcceptanceContextInstructorGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-instructor-group-account",
  "title": "A Statement accepts statement context instructor \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
