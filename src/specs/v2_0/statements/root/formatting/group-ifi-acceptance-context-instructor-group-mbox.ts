...
export const v2StatementsGroupIfiAcceptanceContextInstructorGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-instructor-group-mbox",
  "title": "A Statement accepts statement context instructor \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
