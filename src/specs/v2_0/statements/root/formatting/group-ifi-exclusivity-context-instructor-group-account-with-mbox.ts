...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-account-with-mbox",
  "title": "A Statement rejects statement context instructor \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
