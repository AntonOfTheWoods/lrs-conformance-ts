...
export const v2StatementsVerifyAgentTemplateContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.context-instructor-agent",
  "title": "A Statement accepts statement context instructor \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "context": {
            "instructor": {
              "objectType": "Agent",
              "mbox": "mailto:verify-context-instructor-agent@example.test",
              "name": "Proof Agent"
            }
          }
        },
