...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement substatement actor \"agent\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
