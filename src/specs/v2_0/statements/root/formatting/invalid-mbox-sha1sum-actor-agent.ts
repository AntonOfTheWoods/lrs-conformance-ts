...
export const v2StatementsInvalidMboxSha1sumActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.actor-agent",
  "title": "A Statement rejects statement actor \"agent\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
