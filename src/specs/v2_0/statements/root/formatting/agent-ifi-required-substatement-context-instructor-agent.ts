...
export const v2StatementsAgentIfiRequiredSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.substatement-context-instructor-agent",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
