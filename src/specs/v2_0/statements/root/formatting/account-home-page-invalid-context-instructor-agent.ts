...
export const v2StatementsAccountHomePageInvalidContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
