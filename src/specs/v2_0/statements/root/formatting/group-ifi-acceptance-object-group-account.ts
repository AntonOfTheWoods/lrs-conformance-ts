...
export const v2StatementsGroupIfiAcceptanceObjectGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.object-group-account",
  "title": "A Statement accepts statement object \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
