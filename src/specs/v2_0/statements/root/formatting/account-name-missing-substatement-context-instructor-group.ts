...
export const v2StatementsAccountNameMissingSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
