...
export const v2StatementsAccountHomePageInvalidAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.authority-group",
  "title": "A Statement rejects statement authority \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
