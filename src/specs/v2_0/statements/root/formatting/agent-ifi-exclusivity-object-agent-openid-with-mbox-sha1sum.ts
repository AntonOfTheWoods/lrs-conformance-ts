...
export const v2StatementsAgentIfiExclusivityObjectAgentOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement object \"agent\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
