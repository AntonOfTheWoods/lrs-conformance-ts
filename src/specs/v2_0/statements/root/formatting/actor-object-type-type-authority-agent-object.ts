...
export const v2StatementsActorObjectTypeTypeAuthorityAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.authority-agent-object",
  "title": "A Statement rejects statement authority \"agent\" when objectType is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
