...
export const v2StatementsAgentIfiExclusivityActorAgentAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-account-with-openid",
  "title": "A Statement rejects statement actor \"agent\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
