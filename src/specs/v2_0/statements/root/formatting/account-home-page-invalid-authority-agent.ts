...
export const v2StatementsAccountHomePageInvalidAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
