...
export const v2StatementsAccountHomePageInvalidSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
