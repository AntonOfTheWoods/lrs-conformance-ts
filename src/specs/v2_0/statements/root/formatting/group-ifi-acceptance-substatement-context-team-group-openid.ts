...
export const v2StatementsGroupIfiAcceptanceSubstatementContextTeamGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-context-team-group-openid",
  "title": "A Statement accepts statement substatement context team \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
