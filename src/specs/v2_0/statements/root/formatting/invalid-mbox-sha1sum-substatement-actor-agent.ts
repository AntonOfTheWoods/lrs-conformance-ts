...
export const v2StatementsInvalidMboxSha1sumSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
