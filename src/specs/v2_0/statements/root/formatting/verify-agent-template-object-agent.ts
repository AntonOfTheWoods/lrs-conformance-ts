...
export const v2StatementsVerifyAgentTemplateObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.object-agent",
  "title": "A Statement accepts statement object \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Agent",
            "mbox": "mailto:verify-object-agent@example.test",
            "name": "Proof Agent"
          },
