...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement substatement context instructor \"group\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
