...
export const v2StatementsGroupIfiExclusivityAuthorityGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-account-with-mbox",
  "title": "A Statement rejects statement authority \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
