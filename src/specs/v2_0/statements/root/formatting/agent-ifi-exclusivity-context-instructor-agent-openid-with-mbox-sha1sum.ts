...
export const v2StatementsAgentIfiExclusivityContextInstructorAgentOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.context-instructor-agent-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement context instructor \"agent\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
