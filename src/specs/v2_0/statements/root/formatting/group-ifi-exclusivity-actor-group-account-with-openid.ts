...
export const v2StatementsGroupIfiExclusivityActorGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-account-with-openid",
  "title": "A Statement rejects statement actor \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
