...
export const v2StatementsAccountHomePageInvalidSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.substatement-context-instructor-agent",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
