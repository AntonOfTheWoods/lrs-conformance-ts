...
export const v2StatementsGroupIfiAcceptanceNoMemberObjectGroupAccountNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.object-group-account-no-member",
  "title": "A Statement accepts statement object \"group\" when account is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
