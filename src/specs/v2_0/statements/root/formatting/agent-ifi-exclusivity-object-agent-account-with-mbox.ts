...
export const v2StatementsAgentIfiExclusivityObjectAgentAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-account-with-mbox",
  "title": "A Statement rejects statement object \"agent\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
