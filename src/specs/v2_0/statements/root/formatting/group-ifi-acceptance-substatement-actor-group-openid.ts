...
export const v2StatementsGroupIfiAcceptanceSubstatementActorGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-actor-group-openid",
  "title": "A Statement accepts statement substatement actor \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
