...
export const v2StatementsAccountPropertyAcceptanceSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-property-acceptance.substatement-context-instructor-group",
