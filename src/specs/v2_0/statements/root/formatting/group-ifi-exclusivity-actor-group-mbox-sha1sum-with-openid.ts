...
export const v2StatementsGroupIfiExclusivityActorGroupMboxSha1sumWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-mbox-sha1sum-with-openid",
  "title": "A Statement rejects statement actor \"group\" when mbox_sha1sum is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
