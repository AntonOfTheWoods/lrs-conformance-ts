...
export const v2StatementsInvalidMboxIriActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.actor-agent",
  "title": "A Statement rejects statement actor \"agent\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
