...
export const v2StatementsInvalidMboxMailtoContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
