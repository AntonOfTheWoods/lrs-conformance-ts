...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-openid-with-account",
  "title": "A Statement rejects statement context instructor \"group\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
