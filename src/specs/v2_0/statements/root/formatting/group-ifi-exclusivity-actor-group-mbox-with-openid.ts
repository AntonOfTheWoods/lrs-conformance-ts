...
export const v2StatementsGroupIfiExclusivityActorGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-mbox-with-openid",
  "title": "A Statement rejects statement actor \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
