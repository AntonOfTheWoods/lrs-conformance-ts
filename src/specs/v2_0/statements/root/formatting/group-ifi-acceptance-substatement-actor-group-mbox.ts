...
export const v2StatementsGroupIfiAcceptanceSubstatementActorGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-actor-group-mbox",
  "title": "A Statement accepts statement substatement actor \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
