...
export const v2StatementsInvalidOpenidContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
