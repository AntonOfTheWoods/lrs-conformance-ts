...
export const v2StatementsAgentIfiExclusivityAuthorityAgentMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-mbox-with-openid",
  "title": "A Statement rejects statement authority \"agent\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
