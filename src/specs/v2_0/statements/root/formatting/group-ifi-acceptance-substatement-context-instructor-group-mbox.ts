...
export const v2StatementsGroupIfiAcceptanceSubstatementContextInstructorGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-context-instructor-group-mbox",
  "title": "A Statement accepts statement substatement context instructor \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
