...
export const v2StatementsAgentIfiAcceptanceSubstatementContextInstructorAgentMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.substatement-context-instructor-agent-mbox",
  "title": "A Statement accepts statement substatement context instructor \"agent\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
