...
export const v2StatementsAgentIfiAcceptanceAuthorityAgentMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.authority-agent-mbox-sha1sum",
  "title": "A Statement accepts statement authority \"agent\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
