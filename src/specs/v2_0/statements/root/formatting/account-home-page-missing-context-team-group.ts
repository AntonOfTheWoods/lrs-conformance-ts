...
export const v2StatementsAccountHomePageMissingContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
