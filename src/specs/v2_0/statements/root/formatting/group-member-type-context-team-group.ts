...
export const v2StatementsGroupMemberTypeContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-type.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when member is not an array of Agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00036",
