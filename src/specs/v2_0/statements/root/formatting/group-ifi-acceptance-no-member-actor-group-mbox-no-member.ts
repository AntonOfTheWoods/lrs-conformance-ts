...
export const v2StatementsGroupIfiAcceptanceNoMemberActorGroupMboxNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.actor-group-mbox-no-member",
  "title": "A Statement accepts statement actor \"group\" when mbox is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
