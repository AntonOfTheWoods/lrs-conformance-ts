...
export const v2StatementsAccountHomePageInvalidContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
