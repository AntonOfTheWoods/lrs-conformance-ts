...
export const v2StatementsInvalidMboxSha1sumContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.context-team-group",
  "title": "A Statement rejects statement context team \"group\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
