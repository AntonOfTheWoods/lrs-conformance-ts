...
export const v2StatementsVerifyGroupTemplateContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.context-team-group",
  "title": "A Statement accepts statement context team \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "context": {
            "team": {
              "objectType": "Group",
              "mbox": "mailto:verify-context-team-group@example.test",
              "name": "Proof Group",
              "member": [
                {
                  "objectType": "Agent",
