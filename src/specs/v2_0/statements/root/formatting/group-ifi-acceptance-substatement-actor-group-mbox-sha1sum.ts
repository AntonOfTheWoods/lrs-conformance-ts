...
export const v2StatementsGroupIfiAcceptanceSubstatementActorGroupMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-actor-group-mbox-sha1sum",
  "title": "A Statement accepts statement substatement actor \"group\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
