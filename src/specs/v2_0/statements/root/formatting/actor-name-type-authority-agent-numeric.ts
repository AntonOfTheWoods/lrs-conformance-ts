...
export const v2StatementsActorNameTypeAuthorityAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.authority-agent-numeric",
  "title": "A Statement rejects statement authority \"agent\" when name is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
