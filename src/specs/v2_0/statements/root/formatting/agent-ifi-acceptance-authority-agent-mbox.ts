...
export const v2StatementsAgentIfiAcceptanceAuthorityAgentMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.authority-agent-mbox",
  "title": "A Statement accepts statement authority \"agent\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
