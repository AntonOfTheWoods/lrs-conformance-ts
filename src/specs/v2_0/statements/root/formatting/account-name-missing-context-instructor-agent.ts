...
export const v2StatementsAccountNameMissingContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
