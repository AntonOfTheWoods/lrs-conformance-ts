...
export const v2StatementsInvalidMboxSha1sumObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.object-agent",
  "title": "A Statement rejects statement object \"agent\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
