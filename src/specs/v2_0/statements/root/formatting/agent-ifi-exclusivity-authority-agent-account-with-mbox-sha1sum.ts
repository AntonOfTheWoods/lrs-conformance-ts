...
export const v2StatementsAgentIfiExclusivityAuthorityAgentAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement authority \"agent\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
