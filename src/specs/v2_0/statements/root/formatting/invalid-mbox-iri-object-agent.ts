...
export const v2StatementsInvalidMboxIriObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.object-agent",
  "title": "A Statement rejects statement object \"agent\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
