...
export const v2StatementsAgentIfiExclusivityActorAgentOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-openid-with-account",
  "title": "A Statement rejects statement actor \"agent\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
