...
export const v2StatementsActorObjectTypeTypeSubstatementActorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.substatement-actor-agent-numeric",
  "title": "A Statement rejects statement substatement actor \"agent\" when objectType is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
