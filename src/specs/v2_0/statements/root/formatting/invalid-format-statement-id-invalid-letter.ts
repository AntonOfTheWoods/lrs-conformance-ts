...
export const v2StatementsInvalidFormatStatementIdInvalidLetterCase = {
  "type": "case",
  "id": "v2.statements.invalid-format.statement-id-invalid-letter",
  ...
  "execution": {
    ...
    "request": {
      ...
      "body": {
        "kind": "json",
        "value": {
          "id": "11111111-1111-4111-8111-11111111111G",
          "actor": {
            "objectType": "Agent",
