...
export const v2StatementsActorObjectTypeTypeContextInstructorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.context-instructor-agent-numeric",
  "title": "A Statement rejects statement context instructor \"agent\" when objectType is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
