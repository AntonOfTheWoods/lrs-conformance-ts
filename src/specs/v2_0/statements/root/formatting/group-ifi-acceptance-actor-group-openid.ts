...
export const v2StatementsGroupIfiAcceptanceActorGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.actor-group-openid",
  "title": "A Statement accepts statement actor \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
