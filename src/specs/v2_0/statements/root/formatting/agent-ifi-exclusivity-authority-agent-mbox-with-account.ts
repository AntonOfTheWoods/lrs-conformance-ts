...
export const v2StatementsAgentIfiExclusivityAuthorityAgentMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-mbox-with-account",
  "title": "A Statement rejects statement authority \"agent\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
