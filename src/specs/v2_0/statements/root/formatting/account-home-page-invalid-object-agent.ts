...
export const v2StatementsAccountHomePageInvalidObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.object-agent",
  "title": "A Statement rejects statement object \"agent\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
