...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
