...
export const v2StatementsActorObjectTypeTypeContextInstructorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.context-instructor-agent-object",
  "title": "A Statement rejects statement context instructor \"agent\" when objectType is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
