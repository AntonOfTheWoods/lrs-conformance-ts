...
export const v2StatementsAccountHomePageMissingAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
