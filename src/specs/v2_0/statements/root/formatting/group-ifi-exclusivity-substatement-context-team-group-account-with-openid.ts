...
export const v2StatementsGroupIfiExclusivitySubstatementContextTeamGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-team-group-account-with-openid",
  "title": "A Statement rejects statement substatement context team \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
