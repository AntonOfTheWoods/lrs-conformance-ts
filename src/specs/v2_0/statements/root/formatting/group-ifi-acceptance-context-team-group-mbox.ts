...
export const v2StatementsGroupIfiAcceptanceContextTeamGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-team-group-mbox",
  "title": "A Statement accepts statement context team \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
