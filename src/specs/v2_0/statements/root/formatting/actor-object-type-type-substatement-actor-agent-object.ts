...
export const v2StatementsActorObjectTypeTypeSubstatementActorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.substatement-actor-agent-object",
  "title": "A Statement rejects statement substatement actor \"agent\" when objectType is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
