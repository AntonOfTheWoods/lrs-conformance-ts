...
export const v2StatementsAccountNameMissingSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
