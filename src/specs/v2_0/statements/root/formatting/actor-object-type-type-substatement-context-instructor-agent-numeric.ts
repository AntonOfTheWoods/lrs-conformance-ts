...
export const v2StatementsActorObjectTypeTypeSubstatementContextInstructorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.substatement-context-instructor-agent-numeric",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when objectType is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
