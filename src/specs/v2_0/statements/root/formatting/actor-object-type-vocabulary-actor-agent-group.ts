...
export const v2StatementsActorObjectTypeVocabularyActorAgentGroupCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.actor-agent-group",
  "title": "A Statement rejects statement actor \"agent\" when objectType is not \"Group\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
