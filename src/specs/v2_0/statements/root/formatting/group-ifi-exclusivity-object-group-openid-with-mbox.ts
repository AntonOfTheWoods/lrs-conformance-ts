...
export const v2StatementsGroupIfiExclusivityObjectGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-openid-with-mbox",
  "title": "A Statement rejects statement object \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
