...
export const v2StatementsActorObjectTypeVocabularySubstatementContextInstructorAgentAgentCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.substatement-context-instructor-agent-agent",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when objectType is not \"Agent\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
  ...
  "legacyTrace": {
    ...
    "configFile": "test/v2_0/configs/actors.js"
  },
  "execution": {
    "kind": "single-request",
    "request": {
        ...
        "value": {
          ...
          "object": {
            ...
            "context": {
              "instructor": {
                "objectType": "agent",
                "mbox": "mailto:actor-object-type-agent@example.test",
                "name": "Proof Agent"
              }
            }
          },
