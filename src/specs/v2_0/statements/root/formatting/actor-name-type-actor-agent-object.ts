...
export const v2StatementsActorNameTypeActorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.actor-agent-object",
  "title": "A Statement rejects statement actor \"agent\" when name is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
