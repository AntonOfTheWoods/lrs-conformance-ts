...
export const v2StatementsActorObjectTypeVocabularyObjectAgentAgentCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.object-agent-agent",
  "title": "A Statement rejects statement object \"agent\" when objectType is not \"Agent\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
