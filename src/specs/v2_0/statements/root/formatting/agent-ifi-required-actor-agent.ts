...
export const v2StatementsAgentIfiRequiredActorAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.actor-agent",
  "title": "A Statement rejects statement actor \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
