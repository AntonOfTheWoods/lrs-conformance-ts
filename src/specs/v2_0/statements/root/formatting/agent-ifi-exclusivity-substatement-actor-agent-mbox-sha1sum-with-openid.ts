...
export const v2StatementsAgentIfiExclusivitySubstatementActorAgentMboxSha1sumWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-actor-agent-mbox-sha1sum-with-openid",
  "title": "A Statement rejects statement substatement actor \"agent\" when mbox_sha1sum is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
