...
export const v2StatementsAgentIfiExclusivityAuthorityAgentAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.authority-agent-account-with-mbox",
  "title": "A Statement rejects statement authority \"agent\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
