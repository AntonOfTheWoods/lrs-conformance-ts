...
export const v2StatementsGroupIfiExclusivityAuthorityGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-mbox-with-account",
  "title": "A Statement rejects statement authority \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
