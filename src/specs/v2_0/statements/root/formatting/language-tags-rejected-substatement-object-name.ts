...
export const v2StatementsLanguageTagsRejectedSubstatementObjectNameCase = {
  type: "case",
  id: "v2.statements.language-tags.rejected.substatement-object-name",
  ...
  assertion: {
    ...
    jsonPathNotEquals: [],
    textContains: [],
    notes: ["Statement Formatting", "legacy note: XAPI-00013 upstream comment - in formatting.js"],
  },
