...
export const v2StatementsAgentIfiAcceptanceSubstatementActorAgentAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.substatement-actor-agent-account",
  "title": "A Statement accepts statement substatement actor \"agent\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
