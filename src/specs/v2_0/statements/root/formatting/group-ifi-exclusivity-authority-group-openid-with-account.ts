...
export const v2StatementsGroupIfiExclusivityAuthorityGroupOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-openid-with-account",
  "title": "A Statement rejects statement authority \"group\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
