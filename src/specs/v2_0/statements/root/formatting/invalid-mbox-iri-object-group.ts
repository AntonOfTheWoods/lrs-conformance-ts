...
export const v2StatementsInvalidMboxIriObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.object-group",
  "title": "A Statement rejects statement object \"group\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
