...
export const v2StatementsInvalidMboxIriContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.context-instructor-agent",
  "title": "A Statement rejects statement context instructor \"agent\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
