...
export const v2StatementsGroupIfiAcceptanceContextTeamGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-team-group-account",
  "title": "A Statement accepts statement context team \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
