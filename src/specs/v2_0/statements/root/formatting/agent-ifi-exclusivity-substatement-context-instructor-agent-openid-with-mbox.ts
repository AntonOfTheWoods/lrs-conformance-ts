...
export const v2StatementsAgentIfiExclusivitySubstatementContextInstructorAgentOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.substatement-context-instructor-agent-openid-with-mbox",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
