...
export const v2StatementsActorObjectTypeTypeActorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.actor-agent-object",
  "title": "A Statement rejects statement actor \"agent\" when objectType is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
