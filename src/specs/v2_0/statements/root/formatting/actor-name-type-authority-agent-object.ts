...
export const v2StatementsActorNameTypeAuthorityAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.name-type.authority-agent-object",
  "title": "A Statement rejects statement authority \"agent\" when name is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00033",
