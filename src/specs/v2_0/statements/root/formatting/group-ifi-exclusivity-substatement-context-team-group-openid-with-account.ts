...
export const v2StatementsGroupIfiExclusivitySubstatementContextTeamGroupOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-team-group-openid-with-account",
  "title": "A Statement rejects statement substatement context team \"group\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
