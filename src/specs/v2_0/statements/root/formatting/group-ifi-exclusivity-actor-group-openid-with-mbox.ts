...
export const v2StatementsGroupIfiExclusivityActorGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-openid-with-mbox",
  "title": "A Statement rejects statement actor \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
