...
export const v2StatementsVerifyGroupTemplateSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.substatement-context-team-group",
  "title": "A Statement accepts statement substatement context team \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
        ...
        "value": {
          ...
          "object": {
            ...
            "context": {
              "team": {
                "objectType": "Group",
                "mbox": "mailto:verify-substatement-context-team-group@example.test",
                "name": "Proof Group",
                "member": [
                  {
                    "objectType": "Agent",
