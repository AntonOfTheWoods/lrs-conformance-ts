...
export const v2StatementsGroupMemberRequiredContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
