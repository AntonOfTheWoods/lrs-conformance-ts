...
export const v2StatementsGroupIfiExclusivityAuthorityGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-openid-with-mbox",
  "title": "A Statement rejects statement authority \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
