...
export const v2StatementsGroupIfiOrMemberRequiredSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-or-member-required.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when no IFI and no member are present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
