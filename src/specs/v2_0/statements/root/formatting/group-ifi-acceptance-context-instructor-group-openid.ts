...
export const v2StatementsGroupIfiAcceptanceContextInstructorGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.context-instructor-group-openid",
  "title": "A Statement accepts statement context instructor \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
