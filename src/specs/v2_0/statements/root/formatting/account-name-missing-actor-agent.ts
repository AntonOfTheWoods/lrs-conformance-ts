...
export const v2StatementsAccountNameMissingActorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.actor-agent",
  "title": "A Statement rejects statement actor \"agent\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
