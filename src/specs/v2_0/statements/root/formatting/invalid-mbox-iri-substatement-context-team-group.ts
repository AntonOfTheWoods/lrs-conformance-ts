...
export const v2StatementsInvalidMboxIriSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
