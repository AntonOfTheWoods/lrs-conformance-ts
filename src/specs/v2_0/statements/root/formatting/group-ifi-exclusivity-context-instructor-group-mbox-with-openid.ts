...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-mbox-with-openid",
  "title": "A Statement rejects statement context instructor \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
