...
export const v2StatementsVerifyGroupTemplateObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.object-group",
  "title": "A Statement accepts statement object \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Group",
            "mbox": "mailto:verify-object-group@example.test",
            "name": "Proof Group",
            "member": [
              {
                "objectType": "Agent",
