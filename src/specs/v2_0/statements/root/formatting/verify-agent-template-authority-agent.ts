...
export const v2StatementsVerifyAgentTemplateAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.authority-agent",
  "title": "A Statement accepts statement authority \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "authority": {
            "objectType": "Agent",
            "mbox": "mailto:verify-authority-agent@example.test",
            "name": "Proof Agent"
          }
        },
        "sourceFixture": {
