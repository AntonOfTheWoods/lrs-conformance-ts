...
export const v2StatementsGroupMemberRequiredSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
