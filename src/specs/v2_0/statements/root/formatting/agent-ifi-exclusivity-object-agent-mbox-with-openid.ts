...
export const v2StatementsAgentIfiExclusivityObjectAgentMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-mbox-with-openid",
  "title": "A Statement rejects statement object \"agent\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
