...
export const v2StatementsGroupIfiAcceptanceObjectGroupMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.object-group-mbox-sha1sum",
  "title": "A Statement accepts statement object \"group\" when mbox_sha1sum is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
