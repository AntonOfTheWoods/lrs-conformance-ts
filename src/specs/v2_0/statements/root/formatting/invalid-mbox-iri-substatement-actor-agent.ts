...
export const v2StatementsInvalidMboxIriSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
