...
export const v2StatementsInvalidOpenidActorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.actor-agent",
  "title": "A Statement rejects statement actor \"agent\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
