...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-mbox-with-openid",
  "title": "A Statement rejects statement substatement actor \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
