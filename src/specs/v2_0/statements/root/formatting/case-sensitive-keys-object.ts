...
export const v2StatementsCaseSensitiveKeysObjectCase = {
  "type": "case",
  "id": "v2.statements.case-sensitive-keys.object",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "oBject": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/case-sensitive-object"
          }
        },
        "sourceFixture": {
          "version": "2.0.0",
