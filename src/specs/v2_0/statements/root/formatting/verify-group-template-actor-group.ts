...
export const v2StatementsVerifyGroupTemplateActorGroupCase = {
  "type": "case",
  "id": "v2.statements.verify.group-template.actor-group",
  "title": "A Statement accepts statement actor \"group\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "actor": {
            "objectType": "Group",
            "mbox": "mailto:verify-actor-group@example.test",
            "name": "Proof Group",
            "member": [
              {
                "objectType": "Agent",
