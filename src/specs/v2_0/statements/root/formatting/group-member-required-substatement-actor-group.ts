...
export const v2StatementsGroupMemberRequiredSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-required.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when an anonymous group omits member",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00035",
