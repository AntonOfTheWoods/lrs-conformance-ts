...
export const v2StatementsGroupIfiExclusivityContextTeamGroupOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement context team \"group\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
