...
export const v2StatementsActorObjectTypeTypeActorAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.actor-agent-numeric",
  "title": "A Statement rejects statement actor \"agent\" when objectType is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
