...
export const v2StatementsAccountHomePageMissingSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.substatement-context-instructor-agent",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
