...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-openid-with-account",
  "title": "A Statement rejects statement substatement actor \"group\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
