...
export const v2StatementsAccountHomePageMissingSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
