...
export const v2StatementsInvalidMboxMailtoObjectGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.object-group",
  "title": "A Statement rejects statement object \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
