...
export const v2StatementsVerbDisplayTypeStatementStringCase = {
  "type": "case",
  "id": "v2.statements.verb.display-type.statement-string",
  "title": "A Statement rejects a statement verb when display is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00045",
