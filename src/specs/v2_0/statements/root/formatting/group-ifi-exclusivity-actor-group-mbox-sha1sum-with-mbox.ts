...
export const v2StatementsGroupIfiExclusivityActorGroupMboxSha1sumWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-mbox-sha1sum-with-mbox",
  "title": "A Statement rejects statement actor \"group\" when mbox_sha1sum is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
