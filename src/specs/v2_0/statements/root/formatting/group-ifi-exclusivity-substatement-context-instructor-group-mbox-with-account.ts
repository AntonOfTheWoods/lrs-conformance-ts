...
export const v2StatementsGroupIfiExclusivitySubstatementContextInstructorGroupMboxWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-context-instructor-group-mbox-with-account",
  "title": "A Statement rejects statement substatement context instructor \"group\" when mbox is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
