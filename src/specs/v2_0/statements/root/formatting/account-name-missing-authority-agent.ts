...
export const v2StatementsAccountNameMissingAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
