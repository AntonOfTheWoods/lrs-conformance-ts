...
export const v2StatementsAgentIfiExclusivityObjectAgentMboxWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-mbox-with-mbox-sha1sum",
  "title": "A Statement rejects statement object \"agent\" when mbox is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
