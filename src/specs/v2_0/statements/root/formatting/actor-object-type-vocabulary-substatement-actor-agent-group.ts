...
export const v2StatementsActorObjectTypeVocabularySubstatementActorAgentGroupCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-vocabulary.substatement-actor-agent-group",
  "title": "A Statement rejects statement substatement actor \"agent\" when objectType is not \"Group\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00031",
