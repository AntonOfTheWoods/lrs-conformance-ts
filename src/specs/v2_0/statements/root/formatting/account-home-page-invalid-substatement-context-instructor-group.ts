...
export const v2StatementsAccountHomePageInvalidSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-invalid.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when account.homePage is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
