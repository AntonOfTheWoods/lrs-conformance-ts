...
export const v2StatementsGroupIfiAcceptanceNoMemberContextInstructorGroupOpenidNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.context-instructor-group-openid-no-member",
  "title": "A Statement accepts statement context instructor \"group\" when openid is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
