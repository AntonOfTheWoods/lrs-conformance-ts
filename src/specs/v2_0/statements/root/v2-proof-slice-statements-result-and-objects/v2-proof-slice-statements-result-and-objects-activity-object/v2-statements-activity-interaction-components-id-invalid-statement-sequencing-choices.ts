...
export const v2StatementsActivityInteractionComponentsIdInvalidStatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-invalid.statement-sequencing-choices",
  "title": "A Statement rejects a statement Activity object when sequencing \"choices\" uses a non-string interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-sequencing-choices-id-invalid",
            "definition": {
