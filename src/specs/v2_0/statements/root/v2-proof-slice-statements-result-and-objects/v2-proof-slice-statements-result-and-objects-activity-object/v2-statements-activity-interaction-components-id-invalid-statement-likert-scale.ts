...
export const v2StatementsActivityInteractionComponentsIdInvalidStatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-invalid.statement-likert-scale",
  "title": "A Statement rejects a statement Activity object when likert \"scale\" uses a non-string interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-likert-scale-id-invalid",
            "definition": {
