...
export const v2StatementsActivityInteractionTypeRequiredSubstatementChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.substatement-choices",
  "title": "A Statement rejects a substatement Activity object when choices is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-choices-without-interaction-type",
              "definition": {
                "choices": [
                  {
                    "id": "choice-a",
