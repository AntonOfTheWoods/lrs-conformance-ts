...
export const v2StatementsActivityInteractionComponentsDescriptionTypeStatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.statement-likert-scale",
  "title": "A Statement rejects a statement Activity object when likert \"scale\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-likert-scale-description-type",
            "definition": {
