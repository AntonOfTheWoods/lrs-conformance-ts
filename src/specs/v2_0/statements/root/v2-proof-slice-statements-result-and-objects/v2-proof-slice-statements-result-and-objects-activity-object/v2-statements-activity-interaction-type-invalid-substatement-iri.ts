...
export const v2StatementsActivityInteractionTypeInvalidSubstatementIriCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.substatement-iri",
  "title": "A Statement rejects a substatement Activity object when definition.interactionType uses an IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-invalid-interaction-type-iri",
              "definition": {
                "interactionType": "ab=c://should.fail.com",
