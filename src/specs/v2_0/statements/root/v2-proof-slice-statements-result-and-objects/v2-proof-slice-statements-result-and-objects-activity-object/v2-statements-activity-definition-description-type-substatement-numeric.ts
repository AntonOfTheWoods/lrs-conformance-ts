...
export const v2StatementsActivityDefinitionDescriptionTypeSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-description-type.substatement-numeric",
  "title": "A Statement rejects a substatement Activity object when definition.description is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00059",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-description-numeric",
              "definition": {
                "description": 12345
              }
            }
