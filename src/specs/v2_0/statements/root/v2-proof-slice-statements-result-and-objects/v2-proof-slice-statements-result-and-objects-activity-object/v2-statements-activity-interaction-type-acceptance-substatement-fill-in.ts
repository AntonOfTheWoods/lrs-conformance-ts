...
export const v2StatementsActivityInteractionTypeAcceptanceSubstatementFillInCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.substatement-fill-in",
  "title": "A Statement accepts a substatement Activity object when definition.interactionType uses \"fill-in\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-interaction-type-fill-in",
              "definition": {
