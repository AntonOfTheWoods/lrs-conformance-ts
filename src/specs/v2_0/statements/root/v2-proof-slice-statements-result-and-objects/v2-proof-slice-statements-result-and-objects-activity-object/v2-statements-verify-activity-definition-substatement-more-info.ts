...
export const v2StatementsVerifyActivityDefinitionSubstatementMoreInfoCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.substatement-more-info",
  "title": "A Statement accepts a substatement Activity object verify template when definition contains only \"moreInfo\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-definition-more-info",
              "definition": {
