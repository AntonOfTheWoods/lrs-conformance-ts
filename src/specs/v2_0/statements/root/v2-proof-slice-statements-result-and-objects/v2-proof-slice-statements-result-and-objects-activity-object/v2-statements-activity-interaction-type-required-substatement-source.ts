...
export const v2StatementsActivityInteractionTypeRequiredSubstatementSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.substatement-source",
  "title": "A Statement rejects a substatement Activity object when source is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-source-without-interaction-type",
              "definition": {
                "source": [
                  {
                    "id": "source-a",
