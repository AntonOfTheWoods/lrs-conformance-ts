...
export const v2StatementsObjectTypeVocabularySubstatementActivityCase = {
  "type": "case",
  "id": "v2.statements.object-type-vocabulary.substatement-activity",
  "title": "A Statement rejects a substatement Activity object when objectType does not exactly match Activity",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00046",
