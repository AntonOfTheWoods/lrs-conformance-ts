...
export const v2StatementsActivityInteractionComponentsIdInvalidStatementPerformanceStepsCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-invalid.statement-performance-steps",
  "title": "A Statement rejects a statement Activity object when performance \"steps\" uses a non-string interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00055",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-performance-steps-id-invalid",
            "definition": {
