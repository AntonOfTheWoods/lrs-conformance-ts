...
export const v2StatementsScoreTypeSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.score.type.substatement-numeric",
  "title": "A Statement rejects a substatement result when score is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00079",
