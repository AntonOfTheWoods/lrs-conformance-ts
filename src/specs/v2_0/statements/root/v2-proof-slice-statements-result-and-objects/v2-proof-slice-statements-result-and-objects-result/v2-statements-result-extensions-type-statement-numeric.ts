...
export const v2StatementsResultExtensionsTypeStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.result.extensions-type.statement-numeric",
  "title": "A Statement rejects a statement result when extensions is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00078",
