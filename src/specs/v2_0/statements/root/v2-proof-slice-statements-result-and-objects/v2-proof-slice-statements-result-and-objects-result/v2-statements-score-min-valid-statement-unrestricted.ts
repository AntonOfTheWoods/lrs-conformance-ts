...
export const v2StatementsScoreMinValidStatementUnrestrictedCase = {
  "type": "case",
  "id": "v2.statements.score.min-valid.statement-unrestricted",
  "title": "A Statement accepts a statement result when score uses min without max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00081",
