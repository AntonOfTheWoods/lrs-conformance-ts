...
export const v2StatementsResultDurationValidSubstatementDateTimeCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.substatement-date-time",
  "title": "A Statement accepts a substatement result when duration is P3Y1M29DT4H35M59.14S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
