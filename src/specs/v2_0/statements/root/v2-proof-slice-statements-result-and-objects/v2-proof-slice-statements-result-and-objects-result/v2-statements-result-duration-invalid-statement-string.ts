...
export const v2StatementsResultDurationInvalidStatementStringCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.statement-string",
  "title": "A Statement rejects a statement result when duration is a non-ISO string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
