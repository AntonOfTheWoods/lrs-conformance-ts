...
export const v2StatementsQueryExclusiveVoidedStatementIdWithRelatedActivitiesCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-related-activities",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with related_activities",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
