...
export const v2StatementsQueryFilteringAscendingCase = {
  "type": "case",
  "id": "v2.statements.query.filtering.ascending",
  "title": "The Statements Resource returns statements in ascending stored order when using the \"ascending\" filtering criterion",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00164",
  ...
  "assertion": {
    ...
    "notes": [
      "proof-slice statement filtering criterion ascending"
    ]
  }
