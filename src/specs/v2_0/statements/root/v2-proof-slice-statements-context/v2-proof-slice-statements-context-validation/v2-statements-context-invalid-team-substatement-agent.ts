...
export const v2StatementsContextInvalidTeamSubstatementAgentCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-team.substatement-agent",
  "title": "A Statement rejects a substatement context team when it is an Agent",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00087",
        ...
        "value": {
          ...
          "object": {
            ...
            "context": {
              "team": {
                "objectType": "Agent",
                "mbox": "mailto:substatement-context-team-agent@example.test",
                "name": "Proof Agent"
              }
            }
          },
