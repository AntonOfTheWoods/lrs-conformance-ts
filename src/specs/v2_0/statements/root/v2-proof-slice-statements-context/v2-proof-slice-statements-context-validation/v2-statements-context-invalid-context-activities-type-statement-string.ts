...
export const v2StatementsContextInvalidContextActivitiesTypeStatementStringCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-context-activities-type.statement-string",
  "title": "A Statement rejects a statement context contextActivities when it is not an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00088",
