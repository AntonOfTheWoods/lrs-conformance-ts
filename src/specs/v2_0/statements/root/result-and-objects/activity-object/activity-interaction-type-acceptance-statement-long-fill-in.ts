...
export const v2StatementsActivityInteractionTypeAcceptanceStatementLongFillInCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.statement-long-fill-in",
  "title": "A Statement accepts a statement Activity object when definition.interactionType uses \"long-fill-in\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-interaction-type-long-fill-in",
            "definition": {
