...
export const v2StatementsActivityInteractionTypeRequiredStatementTargetCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.statement-target",
  "title": "A Statement rejects a statement Activity object when target is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-target-without-interaction-type",
            "definition": {
              "target": [
                {
                  "id": "target-a",
