...
export const v2StatementsActivityInteractionComponentsDescriptionTypeSubstatementMatchingTargetCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.substatement-matching-target",
  "title": "A Statement rejects a substatement Activity object when matching \"target\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00054",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-target-description-type",
              "definition": {
