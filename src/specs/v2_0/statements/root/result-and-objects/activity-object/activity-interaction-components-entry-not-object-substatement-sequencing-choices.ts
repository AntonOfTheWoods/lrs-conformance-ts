...
export const v2StatementsActivityInteractionComponentsEntryNotObjectSubstatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.entry-not-object.substatement-sequencing-choices",
  "title": "A Statement rejects a substatement Activity object when sequencing \"choices\" contains a non-object entry",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-sequencing-choices-entry-not-object",
              "definition": {
