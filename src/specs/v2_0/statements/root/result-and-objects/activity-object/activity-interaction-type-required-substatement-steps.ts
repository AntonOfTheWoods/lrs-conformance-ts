...
export const v2StatementsActivityInteractionTypeRequiredSubstatementStepsCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.substatement-steps",
  "title": "A Statement rejects a substatement Activity object when steps is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-steps-without-interaction-type",
              "definition": {
                "steps": [
                  {
                    "id": "step-a",
