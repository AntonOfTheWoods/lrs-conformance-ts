...
export const v2StatementsVerifyActivityTemplateStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.statement-numeric",
  "title": "A Statement accepts a statement Activity object verify template using interactionType \"numeric\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-numeric",
            "definition": {
