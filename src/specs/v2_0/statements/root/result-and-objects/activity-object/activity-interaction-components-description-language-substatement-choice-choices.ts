...
export const v2StatementsActivityInteractionComponentsDescriptionLanguageSubstatementChoiceChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-language.substatement-choice-choices",
  "title": "A Statement rejects a substatement Activity object when choice \"choices\" uses an invalid description language key",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-choice-choices-description-language",
              "definition": {
                ...
                "choices": [
                  {
                    "id": "choice-choices-description-language",
                    "description": {
