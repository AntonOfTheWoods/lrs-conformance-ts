...
export const v2StatementsVerifyActivityTemplateStatementDefaultCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.statement-default",
  "title": "A Statement accepts a statement Activity object default verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-default",
            "definition": {
              "name": {
