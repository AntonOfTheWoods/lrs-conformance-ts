...
export const v2StatementsActivityDefinitionDescriptionTypeSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-description-type.substatement-string",
  "title": "A Statement rejects a substatement Activity object when definition.description is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00059",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-description-string",
              "definition": {
