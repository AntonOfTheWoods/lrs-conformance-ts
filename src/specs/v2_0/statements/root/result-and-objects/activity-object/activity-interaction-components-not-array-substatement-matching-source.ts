...
export const v2StatementsActivityInteractionComponentsNotArraySubstatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.not-array.substatement-matching-source",
  "title": "A Statement rejects a substatement Activity object when matching \"source\" is not an array",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-source-not-array",
              "definition": {
