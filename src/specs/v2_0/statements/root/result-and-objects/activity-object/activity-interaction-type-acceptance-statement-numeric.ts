...
export const v2StatementsActivityInteractionTypeAcceptanceStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.statement-numeric",
  "title": "A Statement accepts a statement Activity object when definition.interactionType uses \"numeric\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-interaction-type-numeric",
            "definition": {
