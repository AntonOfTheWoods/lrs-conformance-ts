...
export const v2StatementsVerifyActivityDefinitionStatementEmptyDefinitionCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.statement-empty-definition",
  "title": "A Statement accepts a statement Activity object verify template when definition omits all optional definition properties",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-definition-empty-definition",
            "definition": {}
          },
