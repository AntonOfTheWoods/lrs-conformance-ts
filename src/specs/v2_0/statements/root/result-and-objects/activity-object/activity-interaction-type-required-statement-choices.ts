...
export const v2StatementsActivityInteractionTypeRequiredStatementChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.statement-choices",
  "title": "A Statement rejects a statement Activity object when choices is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-choices-without-interaction-type",
            "definition": {
              "choices": [
                {
                  "id": "choice-a",
