...
export const v2StatementsVerifyActivityTemplateStatementLongFillInCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.statement-long-fill-in",
  "title": "A Statement accepts a statement Activity object verify template using interactionType \"long-fill-in\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-long-fill-in",
            "definition": {
