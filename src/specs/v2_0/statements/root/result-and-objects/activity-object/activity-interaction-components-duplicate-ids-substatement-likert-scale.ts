...
export const v2StatementsActivityInteractionComponentsDuplicateIdsSubstatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.duplicate-ids.substatement-likert-scale",
  "title": "A Statement rejects a substatement Activity object when likert \"scale\" reuses an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-likert-scale-duplicate-ids",
              "definition": {
