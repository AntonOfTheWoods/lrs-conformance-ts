...
export const v2StatementsObjectTypeVocabularyStatementGroupCase = {
  "type": "case",
  "id": "v2.statements.object-type-vocabulary.statement-group",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "group",
            "mbox": "mailto:proof-object-type-group@example.test",
            "name": "Proof Group",
            "member": [
              {
                "objectType": "Agent",
