...
export const v2StatementsVerifyActivityDefinitionSubstatementEmptyDefinitionCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.substatement-empty-definition",
  "title": "A Statement accepts a substatement Activity object verify template when definition omits all optional definition properties",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-definition-empty-definition",
              "definition": {}
            }
          },
