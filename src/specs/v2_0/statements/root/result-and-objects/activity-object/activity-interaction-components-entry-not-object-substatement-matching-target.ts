...
export const v2StatementsActivityInteractionComponentsEntryNotObjectSubstatementMatchingTargetCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.entry-not-object.substatement-matching-target",
  "title": "A Statement rejects a substatement Activity object when matching \"target\" contains a non-object entry",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00054",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-target-entry-not-object",
              "definition": {
