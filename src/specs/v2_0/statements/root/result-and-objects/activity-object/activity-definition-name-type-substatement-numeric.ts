...
export const v2StatementsActivityDefinitionNameTypeSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-name-type.substatement-numeric",
  "title": "A Statement rejects a substatement Activity object when definition.name is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00056",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-name-numeric",
              "definition": {
                "name": 12345
              }
            }
