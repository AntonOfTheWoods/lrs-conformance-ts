...
export const v2StatementsActivityInteractionComponentsDescriptionLanguageStatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-language.statement-likert-scale",
  "title": "A Statement rejects a statement Activity object when likert \"scale\" uses an invalid description language key",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-likert-scale-description-language",
            "definition": {
