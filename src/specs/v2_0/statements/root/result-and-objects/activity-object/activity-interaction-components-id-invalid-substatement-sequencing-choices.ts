...
export const v2StatementsActivityInteractionComponentsIdInvalidSubstatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-invalid.substatement-sequencing-choices",
  "title": "A Statement rejects a substatement Activity object when sequencing \"choices\" uses a non-string interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-sequencing-choices-id-invalid",
              "definition": {
