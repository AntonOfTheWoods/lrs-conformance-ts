...
export const v2StatementsVerifyActivityTemplateSubstatementSequencingCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.substatement-sequencing",
  "title": "A Statement accepts a substatement Activity object verify template using interactionType \"sequencing\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-sequencing",
              "definition": {
