...
export const v2StatementsActivityInteractionComponentsIdMissingStatementChoiceChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-missing.statement-choice-choices",
  "title": "A Statement rejects a statement Activity object when choice \"choices\" omits an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-choice-choices-id-missing",
            "definition": {
