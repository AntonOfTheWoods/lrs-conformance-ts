...
export const v2StatementsVerifyActivityTemplateSubstatementChoiceCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.substatement-choice",
  "title": "A Statement accepts a substatement Activity object verify template using interactionType \"choice\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-choice",
              "definition": {
