...
export const v2StatementsActivityInteractionComponentsDescriptionTypeSubstatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.substatement-matching-source",
  "title": "A Statement rejects a substatement Activity object when matching \"source\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-source-description-type",
              "definition": {
                ...
                "source": [
                  {
                    "id": "matching-source-description-type",
