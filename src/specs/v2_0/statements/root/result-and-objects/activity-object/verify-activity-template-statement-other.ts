...
export const v2StatementsVerifyActivityTemplateStatementOtherCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.statement-other",
  "title": "A Statement accepts a statement Activity object verify template using interactionType \"other\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
