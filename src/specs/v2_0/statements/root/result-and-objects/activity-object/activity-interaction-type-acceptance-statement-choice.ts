...
export const v2StatementsActivityInteractionTypeAcceptanceStatementChoiceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.statement-choice",
  "title": "A Statement accepts a statement Activity object when definition.interactionType uses \"choice\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-interaction-type-choice",
            "definition": {
