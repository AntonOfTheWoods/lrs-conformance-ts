...
export const v2StatementsActivityInteractionComponentsDescriptionLanguageSubstatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-language.substatement-likert-scale",
  "title": "A Statement rejects a substatement Activity object when likert \"scale\" uses an invalid description language key",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-likert-scale-description-language",
              "definition": {
                ...
                "scale": [
                  {
                    "id": "likert-scale-description-language",
                    "description": {
