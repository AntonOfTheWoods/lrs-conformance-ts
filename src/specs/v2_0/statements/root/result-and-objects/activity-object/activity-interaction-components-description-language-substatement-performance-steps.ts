...
export const v2StatementsActivityInteractionComponentsDescriptionLanguageSubstatementPerformanceStepsCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-language.substatement-performance-steps",
  "title": "A Statement rejects a substatement Activity object when performance \"steps\" uses an invalid description language key",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00055",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-performance-steps-description-language",
              "definition": {
                ...
                "steps": [
                  {
                    "id": "performance-steps-description-language",
                    "description": {
