...
export const v2StatementsActivityInteractionComponentsIdMissingSubstatementLikertScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-missing.substatement-likert-scale",
  "title": "A Statement rejects a substatement Activity object when likert \"scale\" omits an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00052",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-likert-scale-id-missing",
              "definition": {
