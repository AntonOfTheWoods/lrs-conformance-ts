...
export const v2StatementsVerifyActivityTemplateStatementChoiceCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.statement-choice",
  "title": "A Statement accepts a statement Activity object verify template using interactionType \"choice\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-choice",
            "definition": {
