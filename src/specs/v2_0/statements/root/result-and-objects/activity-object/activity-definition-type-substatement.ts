...
export const v2StatementsActivityDefinitionTypeSubstatementCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-type.substatement",
  "title": "A Statement rejects a substatement Activity object when definition is not an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00048",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-definition-not-object",
