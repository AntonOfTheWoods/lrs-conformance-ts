...
export const v2StatementsActivityDefinitionNameTypeSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-name-type.substatement-string",
  "title": "A Statement rejects a substatement Activity object when definition.name is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00056",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-name-string",
              "definition": {
