...
export const v2StatementsVerifyActivityDefinitionStatementDescriptionCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-definition.statement-description",
  "title": "A Statement accepts a statement Activity object verify template when definition contains only \"description\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/verify-statement-definition-description",
            "definition": {
              "description": {
