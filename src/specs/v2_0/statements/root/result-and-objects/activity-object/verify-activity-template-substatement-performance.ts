...
export const v2StatementsVerifyActivityTemplateSubstatementPerformanceCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.substatement-performance",
  "title": "A Statement accepts a substatement Activity object verify template using interactionType \"performance\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-performance",
              "definition": {
