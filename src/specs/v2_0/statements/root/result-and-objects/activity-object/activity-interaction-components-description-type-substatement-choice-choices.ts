...
export const v2StatementsActivityInteractionComponentsDescriptionTypeSubstatementChoiceChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.substatement-choice-choices",
  "title": "A Statement rejects a substatement Activity object when choice \"choices\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-choice-choices-description-type",
              "definition": {
                ...
                "choices": [
                  {
                    "id": "choice-choices-description-type",
