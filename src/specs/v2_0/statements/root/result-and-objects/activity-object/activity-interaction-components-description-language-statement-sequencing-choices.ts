...
export const v2StatementsActivityInteractionComponentsDescriptionLanguageStatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-language.statement-sequencing-choices",
  "title": "A Statement rejects a statement Activity object when sequencing \"choices\" uses an invalid description language key",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-sequencing-choices-description-language",
            "definition": {
