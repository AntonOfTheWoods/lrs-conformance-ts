...
export const v2StatementsObjectAgentGroupRequiresObjectTypeSubstatementAgentCase = {
  "type": "case",
  "id": "v2.statements.object-agent-group.requires-object-type.substatement-agent",
