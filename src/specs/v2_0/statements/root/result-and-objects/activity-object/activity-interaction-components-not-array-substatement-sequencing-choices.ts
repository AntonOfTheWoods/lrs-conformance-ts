...
export const v2StatementsActivityInteractionComponentsNotArraySubstatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.not-array.substatement-sequencing-choices",
  "title": "A Statement rejects a substatement Activity object when sequencing \"choices\" is not an array",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-sequencing-choices-not-array",
              "definition": {
