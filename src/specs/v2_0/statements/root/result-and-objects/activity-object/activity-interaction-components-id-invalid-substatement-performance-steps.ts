...
export const v2StatementsActivityInteractionComponentsIdInvalidSubstatementPerformanceStepsCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-invalid.substatement-performance-steps",
  "title": "A Statement rejects a substatement Activity object when performance \"steps\" uses a non-string interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00055",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-performance-steps-id-invalid",
              "definition": {
