...
export const v2StatementsActivityInteractionTypeRequiredSubstatementScaleCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.substatement-scale",
  "title": "A Statement rejects a substatement Activity object when scale is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-scale-without-interaction-type",
              "definition": {
                "scale": [
                  {
                    "id": "scale-a",
