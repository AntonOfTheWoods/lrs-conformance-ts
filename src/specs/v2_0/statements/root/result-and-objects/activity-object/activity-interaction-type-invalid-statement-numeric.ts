...
export const v2StatementsActivityInteractionTypeInvalidStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.statement-numeric",
  "title": "A Statement rejects a statement Activity object when definition.interactionType uses a number",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-invalid-interaction-type-numeric",
            "definition": {
