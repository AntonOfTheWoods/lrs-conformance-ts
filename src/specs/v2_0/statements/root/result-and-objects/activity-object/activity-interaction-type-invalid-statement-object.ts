...
export const v2StatementsActivityInteractionTypeInvalidStatementObjectCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.statement-object",
  "title": "A Statement rejects a statement Activity object when definition.interactionType uses an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-invalid-interaction-type-object",
            "definition": {
              "interactionType": {
                "invalid": true
              },
