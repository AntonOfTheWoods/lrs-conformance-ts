...
export const v2StatementsActivityInteractionTypeAcceptanceStatementPerformanceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.statement-performance",
  "title": "A Statement accepts a statement Activity object when definition.interactionType uses \"performance\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-interaction-type-performance",
            "definition": {
