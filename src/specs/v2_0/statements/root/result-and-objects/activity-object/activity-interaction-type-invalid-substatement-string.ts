...
export const v2StatementsActivityInteractionTypeInvalidSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.invalid.substatement-string",
  "title": "A Statement rejects a substatement Activity object when definition.interactionType uses an unsupported string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-invalid-interaction-type-string",
              "definition": {
