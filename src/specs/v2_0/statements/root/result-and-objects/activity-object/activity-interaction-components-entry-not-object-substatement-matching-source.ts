...
export const v2StatementsActivityInteractionComponentsEntryNotObjectSubstatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.entry-not-object.substatement-matching-source",
  "title": "A Statement rejects a substatement Activity object when matching \"source\" contains a non-object entry",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-matching-source-entry-not-object",
              "definition": {
