...
export const v2StatementsActivityCorrectResponsesPatternSubstatementValidCase = {
  "type": "case",
  "id": "v2.statements.activity.correct-responses-pattern.substatement-valid",
  "title": "A Statement accepts a substatement Activity object when definition.correctResponsesPattern is an array of strings",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00050",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-correct-responses-pattern-valid",
              "definition": {
