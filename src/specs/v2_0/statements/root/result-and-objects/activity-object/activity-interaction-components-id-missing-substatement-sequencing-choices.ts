...
export const v2StatementsActivityInteractionComponentsIdMissingSubstatementSequencingChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-missing.substatement-sequencing-choices",
  "title": "A Statement rejects a substatement Activity object when sequencing \"choices\" omits an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-sequencing-choices-id-missing",
              "definition": {
