...
export const v2StatementsActivityInteractionTypeRequiredStatementCorrectResponsesPatternCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type-required.statement-correct-responses-pattern",
  "title": "A Statement rejects a statement Activity object when correctResponsesPattern is used without interactionType",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00064",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-correct-responses-pattern-without-interaction-type",
            "definition": {
