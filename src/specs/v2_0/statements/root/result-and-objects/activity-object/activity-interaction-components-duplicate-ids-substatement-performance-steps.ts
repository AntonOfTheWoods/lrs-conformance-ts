...
export const v2StatementsActivityInteractionComponentsDuplicateIdsSubstatementPerformanceStepsCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.duplicate-ids.substatement-performance-steps",
  "title": "A Statement rejects a substatement Activity object when performance \"steps\" reuses an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00055",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-performance-steps-duplicate-ids",
              "definition": {
