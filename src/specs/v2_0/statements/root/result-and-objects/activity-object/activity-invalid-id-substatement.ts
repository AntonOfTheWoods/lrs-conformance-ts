...
export const v2StatementsActivityInvalidIdSubstatementCase = {
  "type": "case",
  "id": "v2.statements.activity.invalid-id.substatement",
  "title": "A Statement rejects a substatement Activity object when id is not an IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00047",
