...
export const v2StatementsActivityInteractionComponentsDescriptionTypeStatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.description-type.statement-matching-source",
  "title": "A Statement rejects a statement Activity object when matching \"source\" uses a non-object description",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-matching-source-description-type",
            "definition": {
