...
export const v2StatementsActivityInvalidIdStatementCase = {
  "type": "case",
  "id": "v2.statements.activity.invalid-id.statement",
  "title": "A Statement rejects a statement Activity object when id is not an IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00047",
