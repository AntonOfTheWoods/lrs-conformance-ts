...
export const v2StatementsActivityInteractionComponentsIdMissingStatementMatchingSourceCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.id-missing.statement-matching-source",
  "title": "A Statement rejects a statement Activity object when matching \"source\" omits an interaction component id",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00053",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-matching-source-id-missing",
            "definition": {
