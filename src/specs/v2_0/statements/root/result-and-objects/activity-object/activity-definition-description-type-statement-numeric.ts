...
export const v2StatementsActivityDefinitionDescriptionTypeStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.activity.definition-description-type.statement-numeric",
  "title": "A Statement rejects a statement Activity object when definition.description is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00059",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Activity",
            "id": "https://example.test/xapi/activities/statement-description-numeric",
            "definition": {
              "description": 12345
            }
          },
