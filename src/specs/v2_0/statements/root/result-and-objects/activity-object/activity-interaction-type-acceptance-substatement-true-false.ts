...
export const v2StatementsActivityInteractionTypeAcceptanceSubstatementTrueFalseCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-type.acceptance.substatement-true-false",
  "title": "A Statement accepts a substatement Activity object when definition.interactionType uses \"true-false\"",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00049",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-interaction-type-true-false",
              "definition": {
