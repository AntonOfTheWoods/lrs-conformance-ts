...
export const v2StatementsActivityCorrectResponsesPatternSubstatementArrayObjectCase = {
  "type": "case",
  "id": "v2.statements.activity.correct-responses-pattern.substatement-array-object",
  "title": "A Statement rejects a substatement Activity object when definition.correctResponsesPattern contains objects",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00050",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-correct-responses-pattern-array-object",
              "definition": {
