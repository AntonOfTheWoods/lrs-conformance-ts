...
export const v2StatementsActivityInteractionComponentsEntryNotObjectSubstatementChoiceChoicesCase = {
  "type": "case",
  "id": "v2.statements.activity.interaction-components.entry-not-object.substatement-choice-choices",
  "title": "A Statement rejects a substatement Activity object when choice \"choices\" contains a non-object entry",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00051",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/substatement-choice-choices-entry-not-object",
              "definition": {
