...
export const v2StatementsVerifyActivityTemplateSubstatementDefaultCase = {
  "type": "case",
  "id": "v2.statements.verify.activity-template.substatement-default",
  "title": "A Statement accepts a substatement Activity object default verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/verify-substatement-default",
              "definition": {
                "name": {
