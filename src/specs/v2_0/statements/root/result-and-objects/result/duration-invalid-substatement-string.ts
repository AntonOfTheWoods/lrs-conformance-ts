...
export const v2StatementsResultDurationInvalidSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.substatement-string",
  "title": "A Statement rejects a substatement result when duration is a non-ISO string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
