...
export const v2StatementsResultDurationInvalidSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.substatement-numeric",
  "title": "A Statement rejects a substatement result when duration is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
