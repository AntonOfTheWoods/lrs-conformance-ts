...
export const v2StatementsScoreScaledValidStatementUpperBoundCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-valid.statement-upper-bound",
  "title": "A Statement accepts a statement result when scaled uses the inclusive upper bound 1.0",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
