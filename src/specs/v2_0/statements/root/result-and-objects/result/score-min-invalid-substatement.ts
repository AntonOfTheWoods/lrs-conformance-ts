...
export const v2StatementsScoreMinInvalidSubstatementCase = {
  "type": "case",
  "id": "v2.statements.score.min-invalid.substatement",
  "title": "A Statement rejects a substatement result when min is greater than max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00081",
