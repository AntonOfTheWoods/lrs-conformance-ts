...
export const v2StatementsResultDurationValidSubstatementHoursMinutesSecondsCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.substatement-hours-minutes-seconds",
  "title": "A Statement accepts a substatement result when duration is PT1H0M0.1S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
