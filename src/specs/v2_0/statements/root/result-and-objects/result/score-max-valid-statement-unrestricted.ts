...
export const v2StatementsScoreMaxValidStatementUnrestrictedCase = {
  "type": "case",
  "id": "v2.statements.score.max-valid.statement-unrestricted",
  "title": "A Statement accepts a statement result when score uses max without min",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00080",
