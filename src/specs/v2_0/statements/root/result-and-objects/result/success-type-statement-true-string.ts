...
export const v2StatementsResultSuccessTypeStatementTrueStringCase = {
  "type": "case",
  "id": "v2.statements.result.success-type.statement-true-string",
  "title": "A Statement rejects a statement result when success is the string true",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00074",
