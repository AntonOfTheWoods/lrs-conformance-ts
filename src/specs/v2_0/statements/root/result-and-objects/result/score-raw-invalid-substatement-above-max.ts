...
export const v2StatementsScoreRawInvalidSubstatementAboveMaxCase = {
  "type": "case",
  "id": "v2.statements.score.raw-invalid.substatement-above-max",
  "title": "A Statement rejects a substatement result when score uses raw greater than max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
