...
export const v2StatementsResultDurationValidStatementTimeOnlyCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.statement-time-only",
  "title": "A Statement accepts a statement result when duration is PT4H35M59.14S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
