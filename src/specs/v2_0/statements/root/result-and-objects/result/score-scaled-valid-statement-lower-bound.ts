...
export const v2StatementsScoreScaledValidStatementLowerBoundCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-valid.statement-lower-bound",
  "title": "A Statement accepts a statement result when scaled uses the inclusive lower bound -1.0",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
