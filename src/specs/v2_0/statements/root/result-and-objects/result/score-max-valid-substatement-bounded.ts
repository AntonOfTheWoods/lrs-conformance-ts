...
export const v2StatementsScoreMaxValidSubstatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.max-valid.substatement-bounded",
  "title": "A Statement accepts a substatement result when score uses max above min with raw between them",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00080",
