...
export const v2StatementsScoreMinValidStatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.min-valid.statement-bounded",
  "title": "A Statement accepts a statement result when score uses min below max with raw between them",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00081",
