...
export const v2StatementsResultDurationValidStatementSecondsOnlyCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.statement-seconds-only",
  "title": "A Statement accepts a statement result when duration is PT16559.14S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
