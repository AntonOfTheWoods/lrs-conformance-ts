...
export const v2StatementsScoreMinValidSubstatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.min-valid.substatement-bounded",
  "title": "A Statement accepts a substatement result when score uses min below max with raw between them",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00081",
