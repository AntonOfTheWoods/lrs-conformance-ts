...
export const v2StatementsResultCompletionTypeStatementFalseStringCase = {
  "type": "case",
  "id": "v2.statements.result.completion-type.statement-false-string",
  "title": "A Statement rejects a statement result when completion is the string false",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00075",
