...
export const v2StatementsResultExtensionsTypeSubstatementNumericCase = {
  "type": "case",
  "id": "v2.statements.result.extensions-type.substatement-numeric",
  "title": "A Statement rejects a substatement result when extensions is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00078",
