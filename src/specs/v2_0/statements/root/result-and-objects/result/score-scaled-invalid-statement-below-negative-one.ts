...
export const v2StatementsScoreScaledInvalidStatementBelowNegativeOneCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-invalid.statement-below-negative-one",
  "title": "A Statement rejects a statement result when scaled is -1.00001",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
