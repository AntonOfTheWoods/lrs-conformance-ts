...
export const v2StatementsResultSuccessTypeSubstatementFalseStringCase = {
  "type": "case",
  "id": "v2.statements.result.success-type.substatement-false-string",
  "title": "A Statement rejects a substatement result when success is the string false",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00074",
