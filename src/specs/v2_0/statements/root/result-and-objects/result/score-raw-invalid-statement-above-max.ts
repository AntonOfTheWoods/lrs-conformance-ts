...
export const v2StatementsScoreRawInvalidStatementAboveMaxCase = {
  "type": "case",
  "id": "v2.statements.score.raw-invalid.statement-above-max",
  "title": "A Statement rejects a statement result when score uses raw greater than max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
