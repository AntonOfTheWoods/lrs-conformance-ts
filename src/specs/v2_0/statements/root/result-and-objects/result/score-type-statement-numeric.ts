...
export const v2StatementsScoreTypeStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.score.type.statement-numeric",
  "title": "A Statement rejects a statement result when score is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00079",
