...
export const v2StatementsResultDurationValidSubstatementWeeksCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.substatement-weeks",
  "title": "A Statement accepts a substatement result when duration is P4W",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
