...
export const v2StatementsScoreTypeStatementStringCase = {
  "type": "case",
  "id": "v2.statements.score.type.statement-string",
  "title": "A Statement rejects a statement result when score is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00079",
