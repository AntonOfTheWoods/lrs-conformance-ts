...
export const v2StatementsResultCompletionTypeSubstatementFalseStringCase = {
  "type": "case",
  "id": "v2.statements.result.completion-type.substatement-false-string",
  "title": "A Statement rejects a substatement result when completion is the string false",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00075",
