...
export const v2StatementsResultDurationInvalidStatementMixedWeekDayCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.statement-mixed-week-day",
  "title": "A Statement rejects a statement result when duration is P4W1D",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
