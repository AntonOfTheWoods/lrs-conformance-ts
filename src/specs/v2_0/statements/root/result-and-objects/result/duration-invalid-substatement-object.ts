...
export const v2StatementsResultDurationInvalidSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.substatement-object",
  "title": "A Statement rejects a substatement result when duration is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
