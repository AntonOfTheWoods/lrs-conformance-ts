...
export const v2StatementsResultDurationValidSubstatementYearsOnlyCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.substatement-years-only",
  "title": "A Statement accepts a substatement result when duration is P3Y",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
