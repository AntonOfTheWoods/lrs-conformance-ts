...
export const v2StatementsResultDurationValidSubstatementSecondsOnlyCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.substatement-seconds-only",
  "title": "A Statement accepts a substatement result when duration is PT16559.14S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
