...
export const v2StatementsScoreRawValidSubstatementBoundedCase = {
  "type": "case",
  "id": "v2.statements.score.raw-valid.substatement-bounded",
  "title": "A Statement accepts a substatement result when score uses raw between min and max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
