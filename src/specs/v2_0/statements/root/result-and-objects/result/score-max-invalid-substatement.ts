...
export const v2StatementsScoreMaxInvalidSubstatementCase = {
  "type": "case",
  "id": "v2.statements.score.max-invalid.substatement",
  "title": "A Statement rejects a substatement result when max is less than min",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00080",
