...
export const v2StatementsScoreScaledValidSubstatementDecimalCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-valid.substatement-decimal",
  "title": "A Statement accepts a substatement result when scaled uses a decimal within range",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
