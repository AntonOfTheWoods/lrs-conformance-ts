...
export const v2StatementsResultResponseTypeSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.result.response-type.substatement-object",
  "title": "A Statement rejects a substatement result when response is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00076",
