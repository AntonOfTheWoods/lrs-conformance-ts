...
export const v2StatementsScoreRawInvalidStatementBelowMinCase = {
  "type": "case",
  "id": "v2.statements.score.raw-invalid.statement-below-min",
  "title": "A Statement rejects a statement result when score uses raw less than min",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
