...
export const v2StatementsResultDurationInvalidStatementNumericCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.statement-numeric",
  "title": "A Statement rejects a statement result when duration is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
