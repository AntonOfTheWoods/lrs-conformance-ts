...
export const v2StatementsScoreRawValidSubstatementUnrestrictedCase = {
  "type": "case",
  "id": "v2.statements.score.raw-valid.substatement-unrestricted",
  "title": "A Statement accepts a substatement result when score uses raw without min or max",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00082",
