...
export const v2StatementsScoreMaxValidSubstatementUnrestrictedCase = {
  "type": "case",
  "id": "v2.statements.score.max-valid.substatement-unrestricted",
  "title": "A Statement accepts a substatement result when score uses max without min",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00080",
