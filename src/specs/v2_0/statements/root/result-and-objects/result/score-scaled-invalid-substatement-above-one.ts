...
export const v2StatementsScoreScaledInvalidSubstatementAboveOneCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-invalid.substatement-above-one",
  "title": "A Statement rejects a substatement result when scaled is 1.01",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
