...
export const v2StatementsResultDurationInvalidSubstatementMixedWeekDayCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.substatement-mixed-week-day",
  "title": "A Statement rejects a substatement result when duration is P4W1D",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
