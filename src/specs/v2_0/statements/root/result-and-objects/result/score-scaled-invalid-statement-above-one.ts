...
export const v2StatementsScoreScaledInvalidStatementAboveOneCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-invalid.statement-above-one",
  "title": "A Statement rejects a statement result when scaled is 1.01",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
