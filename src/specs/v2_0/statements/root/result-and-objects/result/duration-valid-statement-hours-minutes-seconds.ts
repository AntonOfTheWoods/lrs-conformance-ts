...
export const v2StatementsResultDurationValidStatementHoursMinutesSecondsCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.statement-hours-minutes-seconds",
  "title": "A Statement accepts a statement result when duration is PT1H0M0.1S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
