...
export const v2StatementsResultDurationValidStatementYearsOnlyCase = {
  "type": "case",
  "id": "v2.statements.result.duration-valid.statement-years-only",
  "title": "A Statement accepts a statement result when duration is P3Y",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
