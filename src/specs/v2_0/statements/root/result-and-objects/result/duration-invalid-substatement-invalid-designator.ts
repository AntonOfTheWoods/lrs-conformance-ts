...
export const v2StatementsResultDurationInvalidSubstatementInvalidDesignatorCase = {
  "type": "case",
  "id": "v2.statements.result.duration-invalid.substatement-invalid-designator",
  "title": "A Statement rejects a substatement result when duration is PA1H0M0S",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00077",
