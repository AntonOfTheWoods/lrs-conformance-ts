...
export const v2StatementsResultCompletionTypeStatementTrueStringCase = {
  "type": "case",
  "id": "v2.statements.result.completion-type.statement-true-string",
  "title": "A Statement rejects a statement result when completion is the string true",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00075",
