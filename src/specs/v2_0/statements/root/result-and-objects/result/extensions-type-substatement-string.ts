...
export const v2StatementsResultExtensionsTypeSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.result.extensions-type.substatement-string",
  "title": "A Statement rejects a substatement result when extensions is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00078",
