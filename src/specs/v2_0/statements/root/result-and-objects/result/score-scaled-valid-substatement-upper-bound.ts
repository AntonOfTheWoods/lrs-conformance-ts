...
export const v2StatementsScoreScaledValidSubstatementUpperBoundCase = {
  "type": "case",
  "id": "v2.statements.score.scaled-valid.substatement-upper-bound",
  "title": "A Statement accepts a substatement result when scaled uses the inclusive upper bound 1.0",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00083",
