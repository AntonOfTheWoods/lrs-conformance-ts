...
export const v2StatementsQueryExclusiveStatementIdWithRelatedActivitiesCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.statement-id.with-related-activities",
  "title": "The Statements resource rejects a GET request that combines statementId with related_activities",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00151",
