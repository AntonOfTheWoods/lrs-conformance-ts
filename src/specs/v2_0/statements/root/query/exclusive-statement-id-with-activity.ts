...
export const v2StatementsQueryExclusiveStatementIdWithActivityCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.statement-id.with-activity",
  "title": "The Statements resource rejects a GET request that combines statementId with activity",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00151",
