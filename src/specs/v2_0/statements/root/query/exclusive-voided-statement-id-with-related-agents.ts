...
export const v2StatementsQueryExclusiveVoidedStatementIdWithRelatedAgentsCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-related-agents",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with related_agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
