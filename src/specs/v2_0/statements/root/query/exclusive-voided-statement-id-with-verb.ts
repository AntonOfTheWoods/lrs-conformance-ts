...
export const v2StatementsQueryExclusiveVoidedStatementIdWithVerbCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-verb",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with verb",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
