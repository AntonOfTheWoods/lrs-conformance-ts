...
export const v2StatementsQueryStatementResultDirectAgentCase = {
  "type": "case",
  "id": "v2.statements.query.statement-result.direct.agent",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "agent": "{\"objectType\":\"Agent\",\"mbox\":\"mailto:statement-result-agent@example.test\"}"
      }
    }
  },
  "assertion": {
