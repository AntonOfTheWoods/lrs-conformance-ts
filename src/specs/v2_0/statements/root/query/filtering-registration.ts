...
export const v2StatementsQueryFilteringRegistrationCase = {
  "type": "case",
  "id": "v2.statements.query.filtering.registration",
  ...
  "assertion": {
    ...
    "notes": [
      "proof-slice statement filtering criterion registration"
    ]
  }
