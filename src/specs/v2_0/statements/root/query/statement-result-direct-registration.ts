...
export const v2StatementsQueryStatementResultDirectRegistrationCase = {
  "type": "case",
  "id": "v2.statements.query.statement-result.direct.registration",
  ...
  "execution": {
    ...
    "request": {
      ...
      "query": {
        "registration": "33333333-3333-4333-8333-000000001225"
      }
    }
  },
  "assertion": {
