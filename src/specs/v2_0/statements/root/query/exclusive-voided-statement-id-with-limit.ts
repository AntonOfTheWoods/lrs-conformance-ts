...
export const v2StatementsQueryExclusiveVoidedStatementIdWithLimitCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-limit",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with limit",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
