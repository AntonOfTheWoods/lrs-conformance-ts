...
export const v2StatementsQueryExclusiveVoidedStatementIdWithAgentCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-agent",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with agent",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
