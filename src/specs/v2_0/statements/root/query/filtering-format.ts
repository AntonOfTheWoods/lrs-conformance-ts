...
export const v2StatementsQueryFilteringFormatCase = {
  "type": "case",
  "id": "v2.statements.query.filtering.format",
  "title": "The Statements Resource still applies the filtering criterion when GET requests include the \"format\" parameter",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00164",
  ...
  "assertion": {
    ...
    "notes": [
      "proof-slice statement filtering criterion format"
    ]
  }
