...
export const v2StatementsQueryFilteringActivityCase = {
  "type": "case",
  "id": "v2.statements.query.filtering.activity",
    ...
    "steps": [
      {
        ...
        "body": {
          ...
          "value": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/query-activity-match"
            },
            "timestamp": "2026-05-23T12:00:25.000Z"
          },
          "sourceFixture": {
            "version": "2.0.0",
            "domain": "statements",
      ...
      },
      {
        ...
        "body": {
          ...
          "value": {
            ...
            "object": {
              "objectType": "Activity",
              "id": "https://example.test/xapi/activities/query-activity-noise"
            },
            "timestamp": "2026-05-23T12:00:26.000Z"
          },
          "sourceFixture": {
            "version": "2.0.0",
            "domain": "statements",
  ...
  "assertion": {
      ...
      },
      {
        ...
        "jsonPathEquals": [
          ...
          },
          {
            ...
            "equals": "33333333-3333-4333-8333-000000000025"
          }
        ],
        "jsonPathNotEquals": [],
        "textContains": [],
    ...
    "notes": [
      "proof-slice statement filtering criterion activity",
