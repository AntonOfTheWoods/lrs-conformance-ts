...
export const v2StatementsQueryExclusiveVoidedStatementIdWithUntilCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-until",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with until",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
