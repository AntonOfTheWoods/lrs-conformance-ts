...
export const v2StatementsQueryExclusiveVoidedStatementIdWithAscendingCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.voided-statement-id.with-ascending",
  "title": "The Statements resource rejects a GET request that combines voidedStatementId with ascending",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00150",
