...
export const v2StatementsQueryExclusiveStatementIdWithRelatedAgentsCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.statement-id.with-related-agents",
  "title": "The Statements resource rejects a GET request that combines statementId with related_agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00151",
