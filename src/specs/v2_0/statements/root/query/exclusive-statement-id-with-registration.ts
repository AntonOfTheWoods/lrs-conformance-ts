...
export const v2StatementsQueryExclusiveStatementIdWithRegistrationCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.statement-id.with-registration",
  "title": "The Statements resource rejects a GET request that combines statementId with registration",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00151",
