...
export const v2StatementsQueryVoidedTargetsRetainedUntilCase = {
  ...
  "title": "The Statements Resource returns statements targeting a voided statement when using a qualifying \"until\" filter",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00162",
    ...
    "steps": [
      ...
      },
      {
        ...
        "query": {
          ...
          "until": "2026-05-23T12:20:45.000Z"
        }
      }
    ]
  },
        ...
        "jsonPathEquals": [
          {
            "path": [],
            "equals": [
              "33333333-3333-4333-8333-000000001243"
            ]
          }
        ],
        "jsonPathNotEquals": [],
        ...
        "jsonPathEquals": [
          {
            "path": [],
            "equals": [
              "33333333-3333-4333-8333-000000001244"
            ]
          }
        ],
        "jsonPathNotEquals": [],
        ...
        "jsonPathEquals": [
          {
            "path": [],
            "equals": [
              "33333333-3333-4333-8333-000000001245"
            ]
          }
        ],
        "jsonPathNotEquals": [],
