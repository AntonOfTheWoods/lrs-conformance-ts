...
export const v2StatementsQueryExclusiveStatementIdWithLimitCase = {
  "type": "case",
  "id": "v2.statements.query.exclusive.statement-id.with-limit",
  "title": "The Statements resource rejects a GET request that combines statementId with limit",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00151",
