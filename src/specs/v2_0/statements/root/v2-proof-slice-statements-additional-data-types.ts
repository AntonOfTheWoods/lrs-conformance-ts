  ...
  "children": [
    {
      ...
      "legacyTrace": {
        "suiteFile": "/home/anton/dev/tmp/lrs-conformance-test-suite-orig/test/v2_0/4.2.7-Additional-Requirements-for-Data-Types.js"
      },
      "execution": {
      ...
      "assertion": {
        ...
        "notes": [
          "proof-slice additional data types iri comparison"
        ]
      }
    },
    {
      ...
      "assertion": {
        ...
        "textContains": [],
        "notes": [
          "proof-slice additional data types duration precision acceptance"
        ]
      }
    },
    {
      ...
      "assertion": {
        ...
        "notes": [
          "proof-slice additional data types duration precision roundtrip"
        ]
      }
    },
    {
      ...
      "assertion": {
        ...
        "textContains": [],
        "notes": [
          "proof-slice additional data types signed duration comparison"
        ]
      }
    },
    {
      ...
      "assertion": {
        ...
        "notes": [
          "proof-slice additional data types timestamp utc equivalence"
        ]
      }
    }
  ]
