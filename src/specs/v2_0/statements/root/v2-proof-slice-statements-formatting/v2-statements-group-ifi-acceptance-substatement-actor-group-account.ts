...
export const v2StatementsGroupIfiAcceptanceSubstatementActorGroupAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-actor-group-account",
  "title": "A Statement accepts statement substatement actor \"group\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
