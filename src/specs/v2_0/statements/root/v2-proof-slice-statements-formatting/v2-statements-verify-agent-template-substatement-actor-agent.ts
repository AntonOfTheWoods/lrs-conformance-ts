...
export const v2StatementsVerifyAgentTemplateSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.verify.agent-template.substatement-actor-agent",
  "title": "A Statement accepts statement substatement actor \"agent\" verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "actor": {
              "objectType": "Agent",
              "mbox": "mailto:verify-substatement-actor-agent@example.test",
              "name": "Proof Agent"
            },
            "verb": {
