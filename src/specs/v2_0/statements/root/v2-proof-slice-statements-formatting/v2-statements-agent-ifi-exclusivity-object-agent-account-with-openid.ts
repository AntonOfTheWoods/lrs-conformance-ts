...
export const v2StatementsAgentIfiExclusivityObjectAgentAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-account-with-openid",
  "title": "A Statement rejects statement object \"agent\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
