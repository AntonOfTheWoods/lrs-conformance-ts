...
export const v2StatementsGroupIfiExclusivityContextTeamGroupMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-mbox-with-openid",
  "title": "A Statement rejects statement context team \"group\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
