...
export const v2StatementsGroupIfiAcceptanceSubstatementContextInstructorGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.substatement-context-instructor-group-openid",
  "title": "A Statement accepts statement substatement context instructor \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
