...
export const v2StatementsGroupIfiExclusivityAuthorityGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-account-with-openid",
  "title": "A Statement rejects statement authority \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
