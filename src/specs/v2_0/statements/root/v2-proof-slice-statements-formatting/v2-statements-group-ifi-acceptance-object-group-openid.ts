...
export const v2StatementsGroupIfiAcceptanceObjectGroupOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.object-group-openid",
  "title": "A Statement accepts statement object \"group\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
