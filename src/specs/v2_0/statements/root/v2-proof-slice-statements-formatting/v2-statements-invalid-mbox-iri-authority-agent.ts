...
export const v2StatementsInvalidMboxIriAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
