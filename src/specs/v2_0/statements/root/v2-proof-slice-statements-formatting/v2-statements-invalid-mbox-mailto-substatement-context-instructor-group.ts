...
export const v2StatementsInvalidMboxMailtoSubstatementContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.substatement-context-instructor-group",
  "title": "A Statement rejects statement substatement context instructor \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
