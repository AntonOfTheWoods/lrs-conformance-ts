...
export const v2StatementsGroupIfiAcceptanceNoMemberSubstatementContextTeamGroupAccountNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.substatement-context-team-group-account-no-member",
  "title": "A Statement accepts statement substatement context team \"group\" when account is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
