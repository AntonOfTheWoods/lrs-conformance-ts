...
export const v2StatementsGroupIfiExclusivityActorGroupAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.actor-group-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement actor \"group\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
