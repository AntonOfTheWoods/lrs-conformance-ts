...
export const v2StatementsVerifyVerbTemplateSubstatementCase = {
  "type": "case",
  "id": "v2.statements.verify.verb-template.substatement",
  "title": "A Statement accepts a substatement verb verify template",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00014",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "verb": {
              "id": "https://example.test/xapi/verbs/verify-template-substatement",
              "display": {
                "en-US": "verified"
              }
            },
