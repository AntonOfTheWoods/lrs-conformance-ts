...
export const v2StatementsInvalidMboxSha1sumSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-sha1sum.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when mbox_sha1sum is not a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00039",
