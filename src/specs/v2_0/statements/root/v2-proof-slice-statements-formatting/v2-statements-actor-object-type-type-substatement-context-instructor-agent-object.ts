...
export const v2StatementsActorObjectTypeTypeSubstatementContextInstructorAgentObjectCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.substatement-context-instructor-agent-object",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when objectType is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
          ...
          "object": {
            ...
            "context": {
              "instructor": {
                ...
                "mbox": "mailto:actor-object-type-object@example.test",
                "name": "Proof Agent"
              }
            }
          },
