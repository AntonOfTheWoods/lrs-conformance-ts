...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupAccountWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-account-with-mbox",
  "title": "A Statement rejects statement substatement actor \"group\" when account is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
