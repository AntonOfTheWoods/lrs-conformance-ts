...
export const v2StatementsAgentIfiAcceptanceAuthorityAgentAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.authority-agent-account",
  "title": "A Statement accepts statement authority \"agent\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
