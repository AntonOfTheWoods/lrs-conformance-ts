...
export const v2StatementsGroupIfiAcceptanceNoMemberObjectGroupMboxSha1sumNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.object-group-mbox-sha1sum-no-member",
  "title": "A Statement accepts statement object \"group\" when mbox_sha1sum is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
