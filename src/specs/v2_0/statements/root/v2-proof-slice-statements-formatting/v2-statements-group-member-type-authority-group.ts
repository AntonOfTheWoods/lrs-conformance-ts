...
export const v2StatementsGroupMemberTypeAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.group.member-type.authority-group",
  "title": "A Statement rejects statement authority \"group\" when member is not an array of Agents",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00036",
