...
export const v2StatementsAgentIfiAcceptanceSubstatementContextInstructorAgentAccountCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.substatement-context-instructor-agent-account",
  "title": "A Statement accepts statement substatement context instructor \"agent\" when account is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
