...
export const v2StatementsGroupIfiExclusivityAuthorityGroupOpenidWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-openid-with-mbox-sha1sum",
  "title": "A Statement rejects statement authority \"group\" when openid is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
