...
export const v2StatementsAgentIfiAcceptanceSubstatementActorAgentOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-acceptance.substatement-actor-agent-openid",
  "title": "A Statement accepts statement substatement actor \"agent\" when openid is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
