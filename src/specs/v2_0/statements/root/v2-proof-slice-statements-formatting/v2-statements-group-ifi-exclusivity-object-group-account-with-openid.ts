...
export const v2StatementsGroupIfiExclusivityObjectGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-account-with-openid",
  "title": "A Statement rejects statement object \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
