...
export const v2StatementsInvalidMboxMailtoSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
