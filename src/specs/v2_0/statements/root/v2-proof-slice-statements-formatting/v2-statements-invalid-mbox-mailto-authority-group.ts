...
export const v2StatementsInvalidMboxMailtoAuthorityGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.authority-group",
  "title": "A Statement rejects statement authority \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
