...
export const v2StatementsGroupIfiAcceptanceNoMemberSubstatementContextInstructorGroupOpenidNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.substatement-context-instructor-group-openid-no-member",
  "title": "A Statement accepts statement substatement context instructor \"group\" when openid is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
