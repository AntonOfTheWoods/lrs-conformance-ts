...
export const v2StatementsAgentIfiExclusivityObjectAgentMboxSha1sumWithMboxCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.object-agent-mbox-sha1sum-with-mbox",
  "title": "A Statement rejects statement object \"agent\" when mbox_sha1sum is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
