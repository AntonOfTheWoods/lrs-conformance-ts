...
export const v2StatementsInvalidOpenidAuthorityAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-openid.authority-agent",
  "title": "A Statement rejects statement authority \"agent\" when openid is not a valid URI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00040",
