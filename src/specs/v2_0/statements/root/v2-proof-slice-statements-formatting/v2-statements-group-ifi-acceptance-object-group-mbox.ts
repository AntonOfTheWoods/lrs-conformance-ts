...
export const v2StatementsGroupIfiAcceptanceObjectGroupMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance.object-group-mbox",
  "title": "A Statement accepts statement object \"group\" when mbox is the sole IFI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
