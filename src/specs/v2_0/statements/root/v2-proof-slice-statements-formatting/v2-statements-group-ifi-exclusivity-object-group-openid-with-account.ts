...
export const v2StatementsGroupIfiExclusivityObjectGroupOpenidWithAccountCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.object-group-openid-with-account",
  "title": "A Statement rejects statement object \"group\" when openid is used with account",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
