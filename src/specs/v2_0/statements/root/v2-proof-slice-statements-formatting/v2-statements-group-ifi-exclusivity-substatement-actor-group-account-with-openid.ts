...
export const v2StatementsGroupIfiExclusivitySubstatementActorGroupAccountWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.substatement-actor-group-account-with-openid",
  "title": "A Statement rejects statement substatement actor \"group\" when account is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
