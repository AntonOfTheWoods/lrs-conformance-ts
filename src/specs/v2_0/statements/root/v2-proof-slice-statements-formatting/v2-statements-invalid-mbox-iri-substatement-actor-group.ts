...
export const v2StatementsInvalidMboxIriSubstatementActorGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-iri.substatement-actor-group",
  "title": "A Statement rejects statement substatement actor \"group\" when mbox is not a valid mailto IRI",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
