...
export const v2StatementsGroupIfiExclusivityAuthorityGroupMboxWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.authority-group-mbox-with-mbox-sha1sum",
  "title": "A Statement rejects statement authority \"group\" when mbox is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
