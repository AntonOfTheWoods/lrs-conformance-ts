...
export const v2StatementsAccountHomePageMissingContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
