...
export const v2StatementsGroupIfiAcceptanceNoMemberContextTeamGroupMboxNoMemberCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-acceptance-no-member.context-team-group-mbox-no-member",
  "title": "A Statement accepts statement context team \"group\" when mbox is the sole IFI and no member is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
