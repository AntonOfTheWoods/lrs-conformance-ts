...
export const v2StatementsInvalidMboxMailtoSubstatementContextInstructorAgentCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.substatement-context-instructor-agent",
  "title": "A Statement rejects statement substatement context instructor \"agent\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
