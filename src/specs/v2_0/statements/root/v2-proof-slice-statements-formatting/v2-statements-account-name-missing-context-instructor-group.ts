...
export const v2StatementsAccountNameMissingContextInstructorGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.context-instructor-group",
  "title": "A Statement rejects statement context instructor \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
