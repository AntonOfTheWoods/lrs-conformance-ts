...
export const v2StatementsGroupIfiExclusivityContextTeamGroupOpenidWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-openid-with-mbox",
  "title": "A Statement rejects statement context team \"group\" when openid is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
