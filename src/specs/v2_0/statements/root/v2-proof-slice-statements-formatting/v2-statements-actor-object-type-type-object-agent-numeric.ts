...
export const v2StatementsActorObjectTypeTypeObjectAgentNumericCase = {
  "type": "case",
  "id": "v2.statements.actor.object-type-type.object-agent-numeric",
  "title": "A Statement rejects statement object \"agent\" when objectType is numeric",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00032",
