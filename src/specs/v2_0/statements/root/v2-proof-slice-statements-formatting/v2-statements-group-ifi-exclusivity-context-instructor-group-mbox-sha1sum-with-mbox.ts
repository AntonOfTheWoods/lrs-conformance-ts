...
export const v2StatementsGroupIfiExclusivityContextInstructorGroupMboxSha1sumWithMboxCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-instructor-group-mbox-sha1sum-with-mbox",
  "title": "A Statement rejects statement context instructor \"group\" when mbox_sha1sum is used with mbox",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
