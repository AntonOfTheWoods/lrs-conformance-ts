...
export const v2StatementsAccountHomePageMissingObjectAgentCase = {
  "type": "case",
  "id": "v2.statements.account-home-page-missing.object-agent",
  "title": "A Statement rejects statement object \"agent\" when account.homePage is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00042",
