...
export const v2StatementsAgentIfiRequiredSubstatementActorAgentCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-required.substatement-actor-agent",
  "title": "A Statement rejects statement substatement actor \"agent\" when no IFI is present",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
