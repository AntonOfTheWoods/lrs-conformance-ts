...
export const v2StatementsAgentIfiExclusivityActorAgentMboxWithOpenidCase = {
  "type": "case",
  "id": "v2.statements.agent-ifi-exclusivity.actor-agent-mbox-with-openid",
  "title": "A Statement rejects statement actor \"agent\" when mbox is used with openid",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00034",
