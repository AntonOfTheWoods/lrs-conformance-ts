...
export const v2StatementsGroupIfiExclusivityContextTeamGroupAccountWithMboxSha1sumCase = {
  "type": "case",
  "id": "v2.statements.group-ifi-exclusivity.context-team-group-account-with-mbox-sha1sum",
  "title": "A Statement rejects statement context team \"group\" when account is used with mbox_sha1sum",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00037",
