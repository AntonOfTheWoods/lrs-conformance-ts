...
export const v2StatementsAccountNameMissingSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.account-name-missing.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when account.name is missing",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00043",
