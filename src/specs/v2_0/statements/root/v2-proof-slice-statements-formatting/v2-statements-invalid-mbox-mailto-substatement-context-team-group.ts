...
export const v2StatementsInvalidMboxMailtoSubstatementContextTeamGroupCase = {
  "type": "case",
  "id": "v2.statements.invalid-mbox-mailto.substatement-context-team-group",
  "title": "A Statement rejects statement substatement context team \"group\" when mbox is not a valid mailto email address",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00038",
