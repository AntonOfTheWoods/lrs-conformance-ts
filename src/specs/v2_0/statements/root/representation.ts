...
export const v2ProofSliceStatementsRepresentationSuite = {
  ...
  "children": [
        ...
        "steps": [
          ...
          },
          {
            ...
            "expectedHeaders": [
              {
                "key": "content-type",
                "equals": "multipart/mixed; boundary=mock-xapi-statement-attachments"
              }
            ],
            "expectedHeaderPatterns": [],
            "jsonPathEquals": [],
            ...
            "jsonPathEquals": [
              {
                "path": [],
                "equals": [
                  "33333333-3333-4333-8333-000000000230"
                ]
              }
            ],
            "jsonPathNotEquals": [],
            ...
            "jsonPathEquals": [
              {
                "path": [],
                "equals": [
                  "33333333-3333-4333-8333-000000001217"
                ]
              }
            ],
            "jsonPathNotEquals": [],
            ...
            "jsonPathEquals": [
              {
                "path": [],
                "equals": [
                  "33333333-3333-4333-8333-000000001218"
                ]
              }
            ],
            "jsonPathNotEquals": [],
        ...
        "steps": [
          ...
          },
          {
            ...
            "expectedHeaders": [
              {
                "key": "last-modified",
                "equals": "2026-05-23T12:03:51.000Z"
              }
            ],
            "expectedHeaderPatterns": [],
            "jsonPathEquals": [
    ...
    },
    {
      ...
      "title": "The Statements Resource returns X-Experience-API-Consistent-Through for GET requests with \"related_activities\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00153",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns X-Experience-API-Consistent-Through for GET requests with \"related_agents\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00153",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"agent\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"verb\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"activity\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"registration\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"related_activities\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"related_agents\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"since\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"until\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"limit\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"ascending\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"format\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
    ...
    },
    {
      ...
      "title": "The Statements Resource returns an ISO 8601 X-Experience-API-Consistent-Through header for GET requests with \"attachments\"",
      "specVersion": "2.0.0",
      "requirementRefs": [
        {
          "id": "XAPI-00160",
