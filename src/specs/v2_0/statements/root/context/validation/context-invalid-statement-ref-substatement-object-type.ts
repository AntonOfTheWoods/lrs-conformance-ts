...
export const v2StatementsContextInvalidStatementRefSubstatementObjectTypeCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-statement-ref.substatement-object-type",
  "title": "A Statement rejects a substatement context statement when objectType does not exactly match StatementRef",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00092",
