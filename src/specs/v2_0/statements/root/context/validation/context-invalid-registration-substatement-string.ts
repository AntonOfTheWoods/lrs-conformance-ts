...
export const v2StatementsContextInvalidRegistrationSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-registration.substatement-string",
  "title": "A Statement rejects a substatement context registration when it is not a UUID",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00086",
