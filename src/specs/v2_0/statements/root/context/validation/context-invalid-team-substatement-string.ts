...
export const v2StatementsContextInvalidTeamSubstatementStringCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-team.substatement-string",
  "title": "A Statement rejects a substatement context team when it is a string",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00087",
