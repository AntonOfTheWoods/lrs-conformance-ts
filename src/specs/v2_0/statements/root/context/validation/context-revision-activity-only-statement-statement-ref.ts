...
export const v2StatementsContextRevisionActivityOnlyStatementStatementRefCase = {
  "type": "case",
  "id": "v2.statements.context.revision-activity-only.statement-statement-ref",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "id": "33333333-3333-4333-8333-000000000929"
          },
