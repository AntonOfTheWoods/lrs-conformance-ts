...
export const v2StatementsContextRevisionActivityOnlyStatementGroupCase = {
  "type": "case",
  "id": "v2.statements.context.revision-activity-only.statement-group",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Group",
            "mbox": "mailto:context-revision-statement-group@example.test",
            "name": "Proof Group",
            "member": [
              {
                "objectType": "Agent",
