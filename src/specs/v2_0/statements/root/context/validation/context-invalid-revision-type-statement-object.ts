...
export const v2StatementsContextInvalidRevisionTypeStatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-revision-type.statement-object",
  "title": "A Statement rejects a statement context revision when it is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00084",
