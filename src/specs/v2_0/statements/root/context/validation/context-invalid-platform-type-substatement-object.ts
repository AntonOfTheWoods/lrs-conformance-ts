...
export const v2StatementsContextInvalidPlatformTypeSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-platform-type.substatement-object",
  "title": "A Statement rejects a substatement context platform when it is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00085",
