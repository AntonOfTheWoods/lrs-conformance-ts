...
export const v2StatementsContextInvalidRevisionTypeSubstatementNumberCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-revision-type.substatement-number",
  "title": "A Statement rejects a substatement context revision when it is a number",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00084",
