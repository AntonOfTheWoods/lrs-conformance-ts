...
export const v2StatementsContextInvalidPlatformTypeStatementNumberCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-platform-type.statement-number",
  "title": "A Statement rejects a statement context platform when it is a number",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00085",
