...
export const v2StatementsContextPlatformActivityOnlyStatementGroupCase = {
  "type": "case",
  "id": "v2.statements.context.platform-activity-only.statement-group",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Group",
            "mbox": "mailto:context-platform-statement-group@example.test",
            "name": "Proof Group",
            "member": [
              {
                "objectType": "Agent",
