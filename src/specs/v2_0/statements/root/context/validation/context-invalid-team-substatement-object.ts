...
export const v2StatementsContextInvalidTeamSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-team.substatement-object",
  "title": "A Statement rejects a substatement context team when it is not a Group",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00087",
