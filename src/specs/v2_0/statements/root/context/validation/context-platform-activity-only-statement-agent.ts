...
export const v2StatementsContextPlatformActivityOnlyStatementAgentCase = {
  "type": "case",
  "id": "v2.statements.context.platform-activity-only.statement-agent",
    ...
    "request": {
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            "objectType": "Agent",
            "mbox": "mailto:context-platform-statement-agent@example.test",
            "name": "Proof Agent"
          },
