...
export const v2StatementsContextPlatformActivityOnlySubstatementAgentCase = {
  "type": "case",
  "id": "v2.statements.context.platform-activity-only.substatement-agent",
      ...
      "body": {
        ...
        "value": {
          ...
          "object": {
            ...
            "object": {
              "objectType": "Agent",
              "mbox": "mailto:context-platform-substatement-agent@example.test",
              "name": "Proof Agent"
            },
            "context": {
