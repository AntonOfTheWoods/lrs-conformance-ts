...
export const v2StatementsContextInvalidRevisionTypeSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-revision-type.substatement-object",
  "title": "A Statement rejects a substatement context revision when it is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00084",
