...
export const v2StatementsContextInvalidRegistrationSubstatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-registration.substatement-object",
  "title": "A Statement rejects a substatement context registration when it is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00086",
