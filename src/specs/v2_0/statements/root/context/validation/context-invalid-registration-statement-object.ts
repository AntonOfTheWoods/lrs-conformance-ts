...
export const v2StatementsContextInvalidRegistrationStatementObjectCase = {
  "type": "case",
  "id": "v2.statements.context.invalid-registration.statement-object",
  "title": "A Statement rejects a statement context registration when it is an object",
  "specVersion": "2.0.0",
  "requirementRefs": [
    {
      "id": "XAPI-00086",
