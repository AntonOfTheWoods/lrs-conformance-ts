      ...
      config: [
        ...
        },
        {
          ...
          templates: [
            ...
            {
              score: {
                min: VALID_DECIMAL_DIGITS,
                max: VALID_DECIMAL_DIGITS - 0.0000321,
                raw: VALID_DECIMAL_DIGITS - 0.0000033,
              },
            },
          ],
          expect: [400],
      ...
      config: [
        ...
        },
        {
          ...
          templates: [
            ...
            {
              score: {
                max: VALID_MAX_DECIMAL_DIGITS,
                min: VALID_MAX_DECIMAL_DIGITS + 4,
                raw: VALID_MAX_DECIMAL_DIGITS + 1,
              },
            },
          ],
          expect: [400],
        },
        {
          ...
          templates: [
            ...
            { result: "{{results.default}}" },
            {
              score: {
                max: VALID_MAX_DECIMAL_DIGITS,
                raw: VALID_MAX_DECIMAL_DIGITS + 10,
                min: VALID_MAX_DECIMAL_DIGITS + 100,
              },
            },
          ],
          expect: [400],
