...
describe("Context Property Requirements (Data 2.4.6)", function (this: { timeout(ms: number): void }) {
  //Data 2.4.6.s3
   ...
   */
  describe("An LRS returns a ContextActivity in an array, even if only a single ContextActivity is returned (Data 2.4.6.2.s4.b3, XAPI-00096)", function (this: { timeout(ms: number): void }) {
    ...
    types.forEach(function (type) {
      it(
        ...
        async function (this: { timeout(ms: number): void }) {
