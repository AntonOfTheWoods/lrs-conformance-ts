...
describe("Error Codes Requirements (Communication 3.2)", () => {
   ...
   */
  it("An LRS rejects with error code 400 Bad Request any request to an Resource which uses a parameter not recognized by the LRS (Communication 3.2.s2.b1, XAPI-00324)", async function (this: { timeout(ms: number): void }) {
    await expectAsync(
   ...
   */
  describe("An LRS rejects with error code 400 Bad Request any request to an Resource which uses a parameter with differing case (Communication 3.2.s3.b8, XAPI-00325)", function (this: { timeout(ms: number): void }) {
    it('should fail on PUT statement when not using "statementId"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "statementId"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "voidedStatementId"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "agent"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "verb"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "activity"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "registration"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "related_activities"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "related_agents"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "since"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "until"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "limit"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "format"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "attachments"', async function (this: { timeout(ms: number): void }) {
    ...
    it('should fail on GET statement when not using "ascending"', async function (this: { timeout(ms: number): void }) {
   ...
   */
  describe("An LRS does not process any batch of Statements in which one or more Statements is rejected and if necessary, restores the LRS to the state in which it was before the batch began processing (Communication 3.2.s3.b9, XAPI-00326, **Implicit**)", function (this: { timeout(ms: number): void }) {
    it("should not persist any statements on a single failure", async function (this: { timeout(ms: number): void }) {
      this.timeout(0);
      const templates = [{ statement: "{{statements.default}}" }];
