      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.account_no_homepage}}" }],
          expect: [400],
        },
        {
          name: 'statement actor "group" account "homePage" property exists',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_account_no_homepage}}" }],
          expect: [400],
        },
        {
          name: 'statement authority "agent" account "homePage" property exists',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.account_no_homepage}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.account_no_homepage}}" }],
          expect: [400],
        },
        {
      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{agents.account_no_name}}" }],
          expect: [400],
        },
        {
          name: 'statement actor "group" account "name" property exists',
          templates: [{ statement: "{{statements.actor}}" }, { actor: "{{groups.identified_account_no_name}}" }],
          expect: [400],
        },
        {
          name: 'statement authority "agent" account "name" property exists',
          templates: [{ statement: "{{statements.authority}}" }, { authority: "{{agents.account_no_name}}" }],
          expect: [400],
        },
        {
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.object_actor}}" }, { object: "{{agents.account_no_name}}" }],
          expect: [400],
        },
        {
