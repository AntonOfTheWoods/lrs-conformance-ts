      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.default}}" }, { version: VALID_VERSION_1_0 }],
          expect: [200],
        },
        {
          name: 'statement "version" valid 1.0.9',
          templates: [{ statement: "{{statements.default}}" }, { version: VALID_VERSION_1_0_9 }],
          expect: [200],
        },
        {
          name: 'statement "version" invalid string',
          templates: [{ statement: "{{statements.default}}" }, { version: INVALID_STRING }],
          expect: [400],
        },
        {
          name: 'statement "version" invalid 0.9.9',
          templates: [{ statement: "{{statements.default}}" }, { version: INVALID_VERSION_0_9_9 }],
          expect: [400],
        },
        {
          name: 'statement "version" invalid 1.1.0',
          templates: [{ statement: "{{statements.default}}" }, { version: INVALID_VERSION_1_1_0 }],
          expect: [400],
        },
      ],
    },
