      ...
      config: [
        {
          ...
          templates: [{ statement: "{{statements.verb}}" }, { verb: "{{verbs.default}}" }, { id: INVALID_URI }],
          expect: [400],
        },
        {
    ...
    },
    {
      ...
      config: [
        ...
        },
        {
          ...
          templates: [{ statement: "{{statements.verb}}" }, { verb: "{{verbs.default}}" }, INVALID_LANGUAGE_MAP_STRING],
          expect: [400],
        },
        {
